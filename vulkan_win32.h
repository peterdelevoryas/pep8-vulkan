...
typedef vk_result(VKAPI_PTR* pfn_vk_create_win32_surface_khr)(vk_instance                             instance,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_win32_surface_khr(vk_instance                             instance,
                                                            const vk_win32_surface_create_info_khr* p_create_info,
                                                            const vk_allocation_callbacks*          p_allocator,
...
typedef vk_result(VKAPI_PTR* pfn_vk_get_memory_win32_handle_khr)(
    vk_device device, const vk_memory_get_win32_handle_info_khr* p_get_win32_handle_info, HANDLE* p_handle);
...
vk_get_memory_win32_handle_khr(vk_device device, const vk_memory_get_win32_handle_info_khr* p_get_win32_handle_info,
...
typedef vk_result(VKAPI_PTR* pfn_vk_import_semaphore_win32_handle_khr)(
    vk_device device, const vk_import_semaphore_win32_handle_info_khr* p_import_semaphore_win32_handle_info);
typedef vk_result(VKAPI_PTR* pfn_vk_get_semaphore_win32_handle_khr)(
    vk_device device, const vk_semaphore_get_win32_handle_info_khr* p_get_win32_handle_info, HANDLE* p_handle);
...
typedef vk_result(VKAPI_PTR* pfn_vk_import_fence_win32_handle_khr)(
    vk_device device, const vk_import_fence_win32_handle_info_khr* p_import_fence_win32_handle_info);
typedef vk_result(VKAPI_PTR* pfn_vk_get_fence_win32_handle_khr)(
    vk_device device, const vk_fence_get_win32_handle_info_khr* p_get_win32_handle_info, HANDLE* p_handle);
...
VKAPI_ATTR vk_result VKAPI_CALL
vk_get_fence_win32_handle_khr(vk_device device, const vk_fence_get_win32_handle_info_khr* p_get_win32_handle_info,
...
typedef vk_result(VKAPI_PTR* pfn_vk_get_memory_win32_handle_nv)(vk_device device, vk_device_memory memory,
                                                                vk_external_memory_handle_type_flags_nv handle_type,
                                                                HANDLE*                                 p_handle);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_memory_win32_handle_nv(vk_device device, vk_device_memory memory,
                                                              vk_external_memory_handle_type_flags_nv handle_type,
...
typedef vk_result(VKAPI_PTR* pfn_vk_acquire_full_screen_exclusive_mode_ext)(vk_device        device,
                                                                            vk_swapchain_khr swapchain);
typedef vk_result(VKAPI_PTR* pfn_vk_release_full_screen_exclusive_mode_ext)(vk_device        device,
                                                                            vk_swapchain_khr swapchain);
