...
typedef void* (VKAPI_PTR *pfn_vk_allocation_function)(
    void*                                       p_user_data,
    size_t                                      size,
    size_t                                      alignment,
    vk_system_allocation_scope                     allocation_scope);

typedef void (VKAPI_PTR *pfn_vk_free_function)(
    void*                                       p_user_data,
    void*                                       p_memory);

typedef void (VKAPI_PTR *pfn_vk_internal_allocation_notification)(
    void*                                       p_user_data,
    size_t                                      size,
    vk_internal_allocation_type                    allocation_type,
    vk_system_allocation_scope                     allocation_scope);

typedef void (VKAPI_PTR *pfn_vk_internal_free_notification)(
    void*                                       p_user_data,
    size_t                                      size,
    vk_internal_allocation_type                    allocation_type,
    vk_system_allocation_scope                     allocation_scope);

typedef void* (VKAPI_PTR *pfn_vk_reallocation_function)(
    void*                                       p_user_data,
    void*                                       p_original,
    size_t                                      size,
    size_t                                      alignment,
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_instance)(const vk_instance_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_instance* p_instance);
typedef void (VKAPI_PTR *pfn_vk_destroy_instance)(vk_instance instance, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_physical_devices)(vk_instance instance, uint32_t* p_physical_device_count, vk_physical_device* p_physical_devices);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_features)(vk_physical_device physical_device, vk_physical_device_features* p_features);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_format_properties)(vk_physical_device physical_device, vk_format format, vk_format_properties* p_format_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties)(vk_physical_device physical_device, vk_format format, vk_image_type type, vk_image_tiling tiling, vk_image_usage_flags usage, vk_image_create_flags flags, vk_image_format_properties* p_image_format_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_properties)(vk_physical_device physical_device, vk_physical_device_properties* p_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_queue_family_properties)(vk_physical_device physical_device, uint32_t* p_queue_family_property_count, vk_queue_family_properties* p_queue_family_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_memory_properties)(vk_physical_device physical_device, vk_physical_device_memory_properties* p_memory_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_device)(vk_physical_device physical_device, const vk_device_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_device* p_device);
typedef void (VKAPI_PTR *pfn_vk_destroy_device)(vk_device device, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_instance_extension_properties)(const char* p_layer_name, uint32_t* p_property_count, vk_extension_properties* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_device_extension_properties)(vk_physical_device physical_device, const char* p_layer_name, uint32_t* p_property_count, vk_extension_properties* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_instance_layer_properties)(uint32_t* p_property_count, vk_layer_properties* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_device_layer_properties)(vk_physical_device physical_device, uint32_t* p_property_count, vk_layer_properties* p_properties);
typedef void (VKAPI_PTR *pfn_vk_get_device_queue)(vk_device device, uint32_t queue_family_index, uint32_t queue_index, vk_queue* p_queue);
typedef vk_result (VKAPI_PTR *pfn_vk_queue_submit)(vk_queue queue, uint32_t submit_count, const vk_submit_info* p_submits, vk_fence fence);
...
typedef vk_result (VKAPI_PTR *pfn_vk_allocate_memory)(vk_device device, const vk_memory_allocate_info* p_allocate_info, const vk_allocation_callbacks* p_allocator, vk_device_memory* p_memory);
typedef void (VKAPI_PTR *pfn_vk_free_memory)(vk_device device, vk_device_memory memory, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_map_memory)(vk_device device, vk_device_memory memory, vk_device_size offset, vk_device_size size, vk_memory_map_flags flags, void** pp_data);
typedef void (VKAPI_PTR *pfn_vk_unmap_memory)(vk_device device, vk_device_memory memory);
typedef vk_result (VKAPI_PTR *pfn_vk_flush_mapped_memory_ranges)(vk_device device, uint32_t memory_range_count, const vk_mapped_memory_range* p_memory_ranges);
typedef vk_result (VKAPI_PTR *pfn_vk_invalidate_mapped_memory_ranges)(vk_device device, uint32_t memory_range_count, const vk_mapped_memory_range* p_memory_ranges);
typedef void (VKAPI_PTR *pfn_vk_get_device_memory_commitment)(vk_device device, vk_device_memory memory, vk_device_size* p_committed_memory_in_bytes);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_buffer_memory)(vk_device device, vk_buffer buffer, vk_device_memory memory, vk_device_size memory_offset);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_image_memory)(vk_device device, vk_image image, vk_device_memory memory, vk_device_size memory_offset);
typedef void (VKAPI_PTR *pfn_vk_get_buffer_memory_requirements)(vk_device device, vk_buffer buffer, vk_memory_requirements* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_image_memory_requirements)(vk_device device, vk_image image, vk_memory_requirements* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_image_sparse_memory_requirements)(vk_device device, vk_image image, uint32_t* p_sparse_memory_requirement_count, vk_sparse_image_memory_requirements* p_sparse_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties)(vk_physical_device physical_device, vk_format format, vk_image_type type, vk_sample_count_flag_bits samples, vk_image_usage_flags usage, vk_image_tiling tiling, uint32_t* p_property_count, vk_sparse_image_format_properties* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_queue_bind_sparse)(vk_queue queue, uint32_t bind_info_count, const vk_bind_sparse_info* p_bind_info, vk_fence fence);
typedef vk_result (VKAPI_PTR *pfn_vk_create_fence)(vk_device device, const vk_fence_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_fence* p_fence);
typedef void (VKAPI_PTR *pfn_vk_destroy_fence)(vk_device device, vk_fence fence, const vk_allocation_callbacks* p_allocator);
...
typedef vk_result (VKAPI_PTR *pfn_vk_wait_for_fences)(vk_device device, uint32_t fence_count, const vk_fence* p_fences, vk_bool32 wait_all, uint64_t timeout);
typedef vk_result (VKAPI_PTR *pfn_vk_create_semaphore)(vk_device device, const vk_semaphore_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_semaphore* p_semaphore);
typedef void (VKAPI_PTR *pfn_vk_destroy_semaphore)(vk_device device, vk_semaphore semaphore, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_event)(vk_device device, const vk_event_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_event* p_event);
typedef void (VKAPI_PTR *pfn_vk_destroy_event)(vk_device device, vk_event event, const vk_allocation_callbacks* p_allocator);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_query_pool)(vk_device device, const vk_query_pool_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_query_pool* p_query_pool);
typedef void (VKAPI_PTR *pfn_vk_destroy_query_pool)(vk_device device, vk_query_pool query_pool, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_get_query_pool_results)(vk_device device, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count, size_t data_size, void* p_data, vk_device_size stride, vk_query_result_flags flags);
typedef vk_result (VKAPI_PTR *pfn_vk_create_buffer)(vk_device device, const vk_buffer_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_buffer* p_buffer);
typedef void (VKAPI_PTR *pfn_vk_destroy_buffer)(vk_device device, vk_buffer buffer, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_buffer_view)(vk_device device, const vk_buffer_view_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_buffer_view* p_view);
typedef void (VKAPI_PTR *pfn_vk_destroy_buffer_view)(vk_device device, vk_buffer_view buffer_view, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_image)(vk_device device, const vk_image_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_image* p_image);
typedef void (VKAPI_PTR *pfn_vk_destroy_image)(vk_device device, vk_image image, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_get_image_subresource_layout)(vk_device device, vk_image image, const vk_image_subresource* p_subresource, vk_subresource_layout* p_layout);
typedef vk_result (VKAPI_PTR *pfn_vk_create_image_view)(vk_device device, const vk_image_view_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_image_view* p_view);
typedef void (VKAPI_PTR *pfn_vk_destroy_image_view)(vk_device device, vk_image_view image_view, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_shader_module)(vk_device device, const vk_shader_module_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_shader_module* p_shader_module);
typedef void (VKAPI_PTR *pfn_vk_destroy_shader_module)(vk_device device, vk_shader_module shader_module, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_pipeline_cache)(vk_device device, const vk_pipeline_cache_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_pipeline_cache* p_pipeline_cache);
typedef void (VKAPI_PTR *pfn_vk_destroy_pipeline_cache)(vk_device device, vk_pipeline_cache pipeline_cache, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_get_pipeline_cache_data)(vk_device device, vk_pipeline_cache pipeline_cache, size_t* p_data_size, void* p_data);
typedef vk_result (VKAPI_PTR *pfn_vk_merge_pipeline_caches)(vk_device device, vk_pipeline_cache dst_cache, uint32_t src_cache_count, const vk_pipeline_cache* p_src_caches);
typedef vk_result (VKAPI_PTR *pfn_vk_create_graphics_pipelines)(vk_device device, vk_pipeline_cache pipeline_cache, uint32_t create_info_count, const vk_graphics_pipeline_create_info* p_create_infos, const vk_allocation_callbacks* p_allocator, vk_pipeline* p_pipelines);
typedef vk_result (VKAPI_PTR *pfn_vk_create_compute_pipelines)(vk_device device, vk_pipeline_cache pipeline_cache, uint32_t create_info_count, const vk_compute_pipeline_create_info* p_create_infos, const vk_allocation_callbacks* p_allocator, vk_pipeline* p_pipelines);
typedef void (VKAPI_PTR *pfn_vk_destroy_pipeline)(vk_device device, vk_pipeline pipeline, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_pipeline_layout)(vk_device device, const vk_pipeline_layout_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_pipeline_layout* p_pipeline_layout);
typedef void (VKAPI_PTR *pfn_vk_destroy_pipeline_layout)(vk_device device, vk_pipeline_layout pipeline_layout, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_sampler)(vk_device device, const vk_sampler_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_sampler* p_sampler);
typedef void (VKAPI_PTR *pfn_vk_destroy_sampler)(vk_device device, vk_sampler sampler, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_descriptor_set_layout)(vk_device device, const vk_descriptor_set_layout_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_descriptor_set_layout* p_set_layout);
typedef void (VKAPI_PTR *pfn_vk_destroy_descriptor_set_layout)(vk_device device, vk_descriptor_set_layout descriptor_set_layout, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_descriptor_pool)(vk_device device, const vk_descriptor_pool_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_descriptor_pool* p_descriptor_pool);
typedef void (VKAPI_PTR *pfn_vk_destroy_descriptor_pool)(vk_device device, vk_descriptor_pool descriptor_pool, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_reset_descriptor_pool)(vk_device device, vk_descriptor_pool descriptor_pool, vk_descriptor_pool_reset_flags flags);
typedef vk_result (VKAPI_PTR *pfn_vk_allocate_descriptor_sets)(vk_device device, const vk_descriptor_set_allocate_info* p_allocate_info, vk_descriptor_set* p_descriptor_sets);
typedef vk_result (VKAPI_PTR *pfn_vk_free_descriptor_sets)(vk_device device, vk_descriptor_pool descriptor_pool, uint32_t descriptor_set_count, const vk_descriptor_set* p_descriptor_sets);
typedef void (VKAPI_PTR *pfn_vk_update_descriptor_sets)(vk_device device, uint32_t descriptor_write_count, const vk_write_descriptor_set* p_descriptor_writes, uint32_t descriptor_copy_count, const vk_copy_descriptor_set* p_descriptor_copies);
typedef vk_result (VKAPI_PTR *pfn_vk_create_framebuffer)(vk_device device, const vk_framebuffer_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_framebuffer* p_framebuffer);
typedef void (VKAPI_PTR *pfn_vk_destroy_framebuffer)(vk_device device, vk_framebuffer framebuffer, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_render_pass)(vk_device device, const vk_render_pass_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_render_pass* p_render_pass);
typedef void (VKAPI_PTR *pfn_vk_destroy_render_pass)(vk_device device, vk_render_pass render_pass, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_get_render_area_granularity)(vk_device device, vk_render_pass render_pass, vk_extent_2d* p_granularity);
typedef vk_result (VKAPI_PTR *pfn_vk_create_command_pool)(vk_device device, const vk_command_pool_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_command_pool* p_command_pool);
typedef void (VKAPI_PTR *pfn_vk_destroy_command_pool)(vk_device device, vk_command_pool command_pool, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_reset_command_pool)(vk_device device, vk_command_pool command_pool, vk_command_pool_reset_flags flags);
typedef vk_result (VKAPI_PTR *pfn_vk_allocate_command_buffers)(vk_device device, const vk_command_buffer_allocate_info* p_allocate_info, vk_command_buffer* p_command_buffers);
typedef void (VKAPI_PTR *pfn_vk_free_command_buffers)(vk_device device, vk_command_pool command_pool, uint32_t command_buffer_count, const vk_command_buffer* p_command_buffers);
typedef vk_result (VKAPI_PTR *pfn_vk_begin_command_buffer)(vk_command_buffer command_buffer, const vk_command_buffer_begin_info* p_begin_info);
typedef vk_result (VKAPI_PTR *pfn_vk_end_command_buffer)(vk_command_buffer command_buffer);
typedef vk_result (VKAPI_PTR *pfn_vk_reset_command_buffer)(vk_command_buffer command_buffer, vk_command_buffer_reset_flags flags);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_pipeline)(vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point, vk_pipeline pipeline);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_viewport)(vk_command_buffer command_buffer, uint32_t first_viewport, uint32_t viewport_count, const vk_viewport* p_viewports);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_scissor)(vk_command_buffer command_buffer, uint32_t first_scissor, uint32_t scissor_count, const vk_rect2d* p_scissors);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_line_width)(vk_command_buffer command_buffer, float line_width);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_bias)(vk_command_buffer command_buffer, float depth_bias_constant_factor, float depth_bias_clamp, float depth_bias_slope_factor);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_blend_constants)(vk_command_buffer command_buffer, const float blend_constants[4]);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_bounds)(vk_command_buffer command_buffer, float min_depth_bounds, float max_depth_bounds);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_stencil_compare_mask)(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask, uint32_t compare_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_stencil_write_mask)(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask, uint32_t write_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_stencil_reference)(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask, uint32_t reference);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_descriptor_sets)(vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point, vk_pipeline_layout layout, uint32_t first_set, uint32_t descriptor_set_count, const vk_descriptor_set* p_descriptor_sets, uint32_t dynamic_offset_count, const uint32_t* p_dynamic_offsets);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_index_buffer)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_index_type index_type);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_vertex_buffers)(vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count, const vk_buffer* p_buffers, const vk_device_size* p_offsets);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw)(vk_command_buffer command_buffer, uint32_t vertex_count, uint32_t instance_count, uint32_t first_vertex, uint32_t first_instance);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indexed)(vk_command_buffer command_buffer, uint32_t index_count, uint32_t instance_count, uint32_t first_index, int32_t vertex_offset, uint32_t first_instance);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indirect)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_dispatch)(vk_command_buffer command_buffer, uint32_t group_count_x, uint32_t group_count_y, uint32_t group_count_z);
typedef void (VKAPI_PTR *pfn_vk_cmd_dispatch_indirect)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_buffer)(vk_command_buffer command_buffer, vk_buffer src_buffer, vk_buffer dst_buffer, uint32_t region_count, const vk_buffer_copy* p_regions);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_image)(vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout, vk_image dst_image, vk_image_layout dst_image_layout, uint32_t region_count, const vk_image_copy* p_regions);
typedef void (VKAPI_PTR *pfn_vk_cmd_blit_image)(vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout, vk_image dst_image, vk_image_layout dst_image_layout, uint32_t region_count, const vk_image_blit* p_regions, vk_filter filter);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_buffer_to_image)(vk_command_buffer command_buffer, vk_buffer src_buffer, vk_image dst_image, vk_image_layout dst_image_layout, uint32_t region_count, const vk_buffer_image_copy* p_regions);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_image_to_buffer)(vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout, vk_buffer dst_buffer, uint32_t region_count, const vk_buffer_image_copy* p_regions);
typedef void (VKAPI_PTR *pfn_vk_cmd_update_buffer)(vk_command_buffer command_buffer, vk_buffer dst_buffer, vk_device_size dst_offset, vk_device_size data_size, const void* p_data);
typedef void (VKAPI_PTR *pfn_vk_cmd_fill_buffer)(vk_command_buffer command_buffer, vk_buffer dst_buffer, vk_device_size dst_offset, vk_device_size size, uint32_t data);
typedef void (VKAPI_PTR *pfn_vk_cmd_clear_color_image)(vk_command_buffer command_buffer, vk_image image, vk_image_layout image_layout, const vk_clear_color_value* p_color, uint32_t range_count, const vk_image_subresource_range* p_ranges);
typedef void (VKAPI_PTR *pfn_vk_cmd_clear_depth_stencil_image)(vk_command_buffer command_buffer, vk_image image, vk_image_layout image_layout, const vk_clear_depth_stencil_value* p_depth_stencil, uint32_t range_count, const vk_image_subresource_range* p_ranges);
typedef void (VKAPI_PTR *pfn_vk_cmd_clear_attachments)(vk_command_buffer command_buffer, uint32_t attachment_count, const vk_clear_attachment* p_attachments, uint32_t rect_count, const vk_clear_rect* p_rects);
typedef void (VKAPI_PTR *pfn_vk_cmd_resolve_image)(vk_command_buffer command_buffer, vk_image src_image, vk_image_layout src_image_layout, vk_image dst_image, vk_image_layout dst_image_layout, uint32_t region_count, const vk_image_resolve* p_regions);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_event)(vk_command_buffer command_buffer, vk_event event, vk_pipeline_stage_flags stage_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_reset_event)(vk_command_buffer command_buffer, vk_event event, vk_pipeline_stage_flags stage_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_wait_events)(vk_command_buffer command_buffer, uint32_t event_count, const vk_event* p_events, vk_pipeline_stage_flags src_stage_mask, vk_pipeline_stage_flags dst_stage_mask, uint32_t memory_barrier_count, const vk_memory_barrier* p_memory_barriers, uint32_t buffer_memory_barrier_count, const vk_buffer_memory_barrier* p_buffer_memory_barriers, uint32_t image_memory_barrier_count, const vk_image_memory_barrier* p_image_memory_barriers);
typedef void (VKAPI_PTR *pfn_vk_cmd_pipeline_barrier)(vk_command_buffer command_buffer, vk_pipeline_stage_flags src_stage_mask, vk_pipeline_stage_flags dst_stage_mask, vk_dependency_flags dependency_flags, uint32_t memory_barrier_count, const vk_memory_barrier* p_memory_barriers, uint32_t buffer_memory_barrier_count, const vk_buffer_memory_barrier* p_buffer_memory_barriers, uint32_t image_memory_barrier_count, const vk_image_memory_barrier* p_image_memory_barriers);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_query)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query, vk_query_control_flags flags);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_query)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query);
typedef void (VKAPI_PTR *pfn_vk_cmd_reset_query_pool)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count);
typedef void (VKAPI_PTR *pfn_vk_cmd_write_timestamp)(vk_command_buffer command_buffer, vk_pipeline_stage_flag_bits pipeline_stage, vk_query_pool query_pool, uint32_t query);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_query_pool_results)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count, vk_buffer dst_buffer, vk_device_size dst_offset, vk_device_size stride, vk_query_result_flags flags);
typedef void (VKAPI_PTR *pfn_vk_cmd_push_constants)(vk_command_buffer command_buffer, vk_pipeline_layout layout, vk_shader_stage_flags stage_flags, uint32_t offset, uint32_t size, const void* p_values);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_render_pass)(vk_command_buffer command_buffer, const vk_render_pass_begin_info* p_render_pass_begin, vk_subpass_contents contents);
...
typedef void (VKAPI_PTR *pfn_vk_cmd_execute_commands)(vk_command_buffer command_buffer, uint32_t command_buffer_count, const vk_command_buffer* p_command_buffers);
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_instance(
    vk_instance                                  instance,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyInstance");

VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_physical_devices(
    vk_instance                                  instance,
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_features(
    ...
    vk_physical_device_features*                   p_features) __asm("vkGetPhysicalDeviceFeatures");
...
VKAPI_ATTR pfn_vk_void_function VKAPI_CALL vk_get_instance_proc_addr(
    vk_instance                                  instance,
    const char*                                 p_name) __asm("vkGetInstanceProcAddr");

VKAPI_ATTR pfn_vk_void_function VKAPI_CALL vk_get_device_proc_addr(
    vk_device                                    device,
    const char*                                 p_name) __asm("vkGetDeviceProcAddr");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_device(
    vk_physical_device                            physical_device,
    const vk_device_create_info*                   p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_device*                                   p_device) __asm("vkCreateDevice");

VKAPI_ATTR void VKAPI_CALL vk_destroy_device(
    vk_device                                    device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_instance_layer_properties(
    uint32_t*                                   p_property_count,
    vk_layer_properties*                          p_properties) __asm("vkEnumerateInstanceLayerProperties");

VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_device_layer_properties(
    vk_physical_device                            physical_device,
    uint32_t*                                   p_property_count,
    vk_layer_properties*                          p_properties) __asm("vkEnumerateDeviceLayerProperties");

VKAPI_ATTR void VKAPI_CALL vk_get_device_queue(
    vk_device                                    device,
    uint32_t                                    queue_family_index,
    uint32_t                                    queue_index,
    vk_queue*                                    p_queue) __asm("vkGetDeviceQueue");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_submit(
    vk_queue                                     queue,
    uint32_t                                    submit_count,
    const vk_submit_info*                         p_submits,
    vk_fence                                     fence) __asm("vkQueueSubmit");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_wait_idle(
    vk_queue                                     queue) __asm("vkQueueWaitIdle");

VKAPI_ATTR vk_result VKAPI_CALL vk_device_wait_idle(
    vk_device                                    device) __asm("vkDeviceWaitIdle");

VKAPI_ATTR vk_result VKAPI_CALL vk_allocate_memory(
    vk_device                                    device,
    const vk_memory_allocate_info*                 p_allocate_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_device_memory*                             p_memory) __asm("vkAllocateMemory");

VKAPI_ATTR void VKAPI_CALL vk_free_memory(
    vk_device                                    device,
    vk_device_memory                              memory,
    const vk_allocation_callbacks*                p_allocator) __asm("vkFreeMemory");

VKAPI_ATTR vk_result VKAPI_CALL vk_map_memory(
    vk_device                                    device,
    vk_device_memory                              memory,
    vk_device_size                                offset,
    vk_device_size                                size,
    vk_memory_map_flags                            flags,
    void**                                      pp_data) __asm("vkMapMemory");

VKAPI_ATTR void VKAPI_CALL vk_unmap_memory(
    vk_device                                    device,
    vk_device_memory                              memory) __asm("vkUnmapMemory");

VKAPI_ATTR vk_result VKAPI_CALL vk_flush_mapped_memory_ranges(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_get_device_memory_commitment(
    vk_device                                    device,
    vk_device_memory                              memory,
    vk_device_size*                               p_committed_memory_in_bytes) __asm("vkGetDeviceMemoryCommitment");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_buffer_memory(
    vk_device                                    device,
    vk_buffer                                    buffer,
    vk_device_memory                              memory,
    vk_device_size                                memory_offset) __asm("vkBindBufferMemory");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_image_memory(
    vk_device                                    device,
    vk_image                                     image,
    vk_device_memory                              memory,
    vk_device_size                                memory_offset) __asm("vkBindImageMemory");

VKAPI_ATTR void VKAPI_CALL vk_get_buffer_memory_requirements(
    vk_device                                    device,
    vk_buffer                                    buffer,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_queue_bind_sparse(
    vk_queue                                     queue,
    uint32_t                                    bind_info_count,
    const vk_bind_sparse_info*                     p_bind_info,
    vk_fence                                     fence) __asm("vkQueueBindSparse");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_fence(
    vk_device                                    device,
    const vk_fence_create_info*                    p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_fence*                                    p_fence) __asm("vkCreateFence");

VKAPI_ATTR void VKAPI_CALL vk_destroy_fence(
    vk_device                                    device,
    vk_fence                                     fence,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyFence");

VKAPI_ATTR vk_result VKAPI_CALL vk_reset_fences(
    vk_device                                    device,
    uint32_t                                    fence_count,
    const vk_fence*                              p_fences) __asm("vkResetFences");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_fence_status(
    vk_device                                    device,
    vk_fence                                     fence) __asm("vkGetFenceStatus");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_for_fences(
    vk_device                                    device,
    uint32_t                                    fence_count,
    const vk_fence*                              p_fences,
    vk_bool32                                    wait_all,
    uint64_t                                    timeout) __asm("vkWaitForFences");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_semaphore(
    vk_device                                    device,
    const vk_semaphore_create_info*                p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_semaphore*                                p_semaphore) __asm("vkCreateSemaphore");

VKAPI_ATTR void VKAPI_CALL vk_destroy_semaphore(
    vk_device                                    device,
    vk_semaphore                                 semaphore,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroySemaphore");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_event(
    vk_device                                    device,
    const vk_event_create_info*                    p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_event*                                    p_event) __asm("vkCreateEvent");

VKAPI_ATTR void VKAPI_CALL vk_destroy_event(
    vk_device                                    device,
    vk_event                                     event,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyEvent");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_event_status(
    vk_device                                    device,
    vk_event                                     event) __asm("vkGetEventStatus");

VKAPI_ATTR vk_result VKAPI_CALL vk_set_event(
    vk_device                                    device,
    vk_event                                     event) __asm("vkSetEvent");

VKAPI_ATTR vk_result VKAPI_CALL vk_reset_event(
    vk_device                                    device,
    vk_event                                     event) __asm("vkResetEvent");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_query_pool(
    vk_device                                    device,
    const vk_query_pool_create_info*                p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_query_pool(
    ...
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyQueryPool");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_query_pool_results(
    vk_device                                    device,
    vk_query_pool                                 query_pool,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_buffer(
    vk_device                                    device,
    const vk_buffer_create_info*                   p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_buffer*                                   p_buffer) __asm("vkCreateBuffer");

VKAPI_ATTR void VKAPI_CALL vk_destroy_buffer(
    vk_device                                    device,
    vk_buffer                                    buffer,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyBuffer");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_buffer_view(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_buffer_view(
    vk_device                                    device,
    vk_buffer_view                                buffer_view,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyBufferView");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_image(
    vk_device                                    device,
    const vk_image_create_info*                    p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_image*                                    p_image) __asm("vkCreateImage");

VKAPI_ATTR void VKAPI_CALL vk_destroy_image(
    vk_device                                    device,
    vk_image                                     image,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyImage");

VKAPI_ATTR void VKAPI_CALL vk_get_image_subresource_layout(
    vk_device                                    device,
    vk_image                                     image,
    const vk_image_subresource*                   p_subresource,
    vk_subresource_layout*                        p_layout) __asm("vkGetImageSubresourceLayout");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_image_view(
    vk_device                                    device,
    const vk_image_view_create_info*                p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_image_view(
    vk_device                                    device,
    vk_image_view                                 image_view,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyImageView");
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_shader_module(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_pipeline_cache(
    vk_device                                    device,
    vk_pipeline_cache                             pipeline_cache,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyPipelineCache");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_cache_data(
    vk_device                                    device,
    vk_pipeline_cache                             pipeline_cache,
    size_t*                                     p_data_size,
    void*                                       p_data) __asm("vkGetPipelineCacheData");

VKAPI_ATTR vk_result VKAPI_CALL vk_merge_pipeline_caches(
    vk_device                                    device,
    vk_pipeline_cache                             dst_cache,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_compute_pipelines(
    vk_device                                    device,
    vk_pipeline_cache                             pipeline_cache,
    uint32_t                                    create_info_count,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_pipeline(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_pipeline_layout(
    vk_device                                    device,
    vk_pipeline_layout                            pipeline_layout,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyPipelineLayout");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_sampler(
    vk_device                                    device,
    const vk_sampler_create_info*                  p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_sampler*                                  p_sampler) __asm("vkCreateSampler");

VKAPI_ATTR void VKAPI_CALL vk_destroy_sampler(
    vk_device                                    device,
    vk_sampler                                   sampler,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroySampler");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_descriptor_set_layout(
    vk_device                                    device,
    const vk_descriptor_set_layout_create_info*      p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_descriptor_set_layout*                      p_set_layout) __asm("vkCreateDescriptorSetLayout");

VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_set_layout(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_update_descriptor_sets(
    ...
    const vk_copy_descriptor_set*                  p_descriptor_copies) __asm("vkUpdateDescriptorSets");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_framebuffer(
    vk_device                                    device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_render_pass(
    vk_device                                    device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_begin_command_buffer(
    ...
    const vk_command_buffer_begin_info*             p_begin_info) __asm("vkBeginCommandBuffer");

VKAPI_ATTR vk_result VKAPI_CALL vk_end_command_buffer(
    vk_command_buffer                             command_buffer) __asm("vkEndCommandBuffer");

VKAPI_ATTR vk_result VKAPI_CALL vk_reset_command_buffer(
    vk_command_buffer                             command_buffer,
    vk_command_buffer_reset_flags                   flags) __asm("vkResetCommandBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_pipeline(
    vk_command_buffer                             command_buffer,
    vk_pipeline_bind_point                         pipeline_bind_point,
    vk_pipeline                                  pipeline) __asm("vkCmdBindPipeline");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_viewport(
    vk_command_buffer                             command_buffer,
    uint32_t                                    first_viewport,
    uint32_t                                    viewport_count,
    const vk_viewport*                           p_viewports) __asm("vkCmdSetViewport");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_scissor(
    vk_command_buffer                             command_buffer,
    uint32_t                                    first_scissor,
    uint32_t                                    scissor_count,
    const vk_rect2d*                             p_scissors) __asm("vkCmdSetScissor");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_line_width(
    vk_command_buffer                             command_buffer,
    float                                       line_width) __asm("vkCmdSetLineWidth");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_bias(
    vk_command_buffer                             command_buffer,
    float                                       depth_bias_constant_factor,
    float                                       depth_bias_clamp,
    float                                       depth_bias_slope_factor) __asm("vkCmdSetDepthBias");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_blend_constants(
    vk_command_buffer                             command_buffer,
    const float                                 blend_constants[4]) __asm("vkCmdSetBlendConstants");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_bounds(
    vk_command_buffer                             command_buffer,
    float                                       min_depth_bounds,
    float                                       max_depth_bounds) __asm("vkCmdSetDepthBounds");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_stencil_compare_mask(
    vk_command_buffer                             command_buffer,
    vk_stencil_face_flags                          face_mask,
    uint32_t                                    compare_mask) __asm("vkCmdSetStencilCompareMask");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_stencil_write_mask(
    vk_command_buffer                             command_buffer,
    vk_stencil_face_flags                          face_mask,
    uint32_t                                    write_mask) __asm("vkCmdSetStencilWriteMask");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_stencil_reference(
    vk_command_buffer                             command_buffer,
    vk_stencil_face_flags                          face_mask,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_descriptor_sets(
    ...
    const uint32_t*                             p_dynamic_offsets) __asm("vkCmdBindDescriptorSets");

VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_index_buffer(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    vk_index_type                                 index_type) __asm("vkCmdBindIndexBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_vertex_buffers(
    vk_command_buffer                             command_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw(
    vk_command_buffer                             command_buffer,
    uint32_t                                    vertex_count,
    uint32_t                                    instance_count,
    uint32_t                                    first_vertex,
    uint32_t                                    first_instance) __asm("vkCmdDraw");

VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed(
    vk_command_buffer                             command_buffer,
    uint32_t                                    index_count,
    uint32_t                                    instance_count,
    uint32_t                                    first_index,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indirect(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    uint32_t                                    draw_count,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed_indirect(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    uint32_t                                    draw_count,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch(
    vk_command_buffer                             command_buffer,
    uint32_t                                    group_count_x,
    uint32_t                                    group_count_y,
    uint32_t                                    group_count_z) __asm("vkCmdDispatch");

VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch_indirect(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset) __asm("vkCmdDispatchIndirect");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_buffer(
    vk_command_buffer                             command_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_image(
    vk_command_buffer                             command_buffer,
    vk_image                                     src_image,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_blit_image(
    vk_command_buffer                             command_buffer,
    vk_image                                     src_image,
    vk_image_layout                               src_image_layout,
    vk_image                                     dst_image,
    vk_image_layout                               dst_image_layout,
    uint32_t                                    region_count,
    const vk_image_blit*                          p_regions,
    vk_filter                                    filter) __asm("vkCmdBlitImage");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_buffer_to_image(
    ...
    vk_image_layout                               dst_image_layout,
    uint32_t                                    region_count,
    const vk_buffer_image_copy*                    p_regions) __asm("vkCmdCopyBufferToImage");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_image_to_buffer(
    ...
    vk_buffer                                    dst_buffer,
    uint32_t                                    region_count,
    const vk_buffer_image_copy*                    p_regions) __asm("vkCmdCopyImageToBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_update_buffer(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    dst_buffer,
    vk_device_size                                dst_offset,
    vk_device_size                                data_size,
    const void*                                 p_data) __asm("vkCmdUpdateBuffer");

VKAPI_ATTR void VKAPI_CALL vk_cmd_fill_buffer(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    dst_buffer,
    vk_device_size                                dst_offset,
    vk_device_size                                size,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_color_image(
    ...
    vk_image                                     image,
    vk_image_layout                               image_layout,
    const vk_clear_color_value*                    p_color,
    uint32_t                                    range_count,
    const vk_image_subresource_range*              p_ranges) __asm("vkCmdClearColorImage");

VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_depth_stencil_image(
    vk_command_buffer                             command_buffer,
    vk_image                                     image,
    vk_image_layout                               image_layout,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_clear_attachments(
    vk_command_buffer                             command_buffer,
    uint32_t                                    attachment_count,
    const vk_clear_attachment*                    p_attachments,
    uint32_t                                    rect_count,
    const vk_clear_rect*                          p_rects) __asm("vkCmdClearAttachments");

VKAPI_ATTR void VKAPI_CALL vk_cmd_resolve_image(
    vk_command_buffer                             command_buffer,
    vk_image                                     src_image,
    vk_image_layout                               src_image_layout,
    vk_image                                     dst_image,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_event(
    vk_command_buffer                             command_buffer,
    vk_event                                     event,
    vk_pipeline_stage_flags                        stage_mask) __asm("vkCmdSetEvent");

VKAPI_ATTR void VKAPI_CALL vk_cmd_reset_event(
    vk_command_buffer                             command_buffer,
    vk_event                                     event,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_query(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    query,
    vk_query_control_flags                         flags) __asm("vkCmdBeginQuery");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_query(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    query) __asm("vkCmdEndQuery");

VKAPI_ATTR void VKAPI_CALL vk_cmd_reset_query_pool(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    first_query,
    uint32_t                                    query_count) __asm("vkCmdResetQueryPool");

VKAPI_ATTR void VKAPI_CALL vk_cmd_write_timestamp(
    vk_command_buffer                             command_buffer,
    vk_pipeline_stage_flag_bits                     pipeline_stage,
    vk_query_pool                                 query_pool,
    uint32_t                                    query) __asm("vkCmdWriteTimestamp");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_query_pool_results(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    first_query,
    uint32_t                                    query_count,
    ...
    vk_device_size                                dst_offset,
    vk_device_size                                stride,
    vk_query_result_flags                          flags) __asm("vkCmdCopyQueryPoolResults");

VKAPI_ATTR void VKAPI_CALL vk_cmd_push_constants(
    vk_command_buffer                             command_buffer,
    vk_pipeline_layout                            layout,
    vk_shader_stage_flags                          stage_flags,
    uint32_t                                    offset,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_render_pass(
    vk_command_buffer                             command_buffer,
    const vk_render_pass_begin_info*                p_render_pass_begin,
    vk_subpass_contents                           contents) __asm("vkCmdBeginRenderPass");

VKAPI_ATTR void VKAPI_CALL vk_cmd_next_subpass(
    vk_command_buffer                             command_buffer,
    vk_subpass_contents                           contents) __asm("vkCmdNextSubpass");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_render_pass(
    vk_command_buffer                             command_buffer) __asm("vkCmdEndRenderPass");

VKAPI_ATTR void VKAPI_CALL vk_cmd_execute_commands(
    vk_command_buffer                             command_buffer,
    uint32_t                                    command_buffer_count,
...
typedef vk_result (VKAPI_PTR *pfn_vk_bind_buffer_memory2)(vk_device device, uint32_t bind_info_count, const vk_bind_buffer_memory_info* p_bind_infos);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_image_memory2)(vk_device device, uint32_t bind_info_count, const vk_bind_image_memory_info* p_bind_infos);
typedef void (VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features)(vk_device device, uint32_t heap_index, uint32_t local_device_index, uint32_t remote_device_index, vk_peer_memory_feature_flags* p_peer_memory_features);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_device_mask)(vk_command_buffer command_buffer, uint32_t device_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_dispatch_base)(vk_command_buffer command_buffer, uint32_t base_group_x, uint32_t base_group_y, uint32_t base_group_z, uint32_t group_count_x, uint32_t group_count_y, uint32_t group_count_z);
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_physical_device_groups)(vk_instance instance, uint32_t* p_physical_device_group_count, vk_physical_device_group_properties* p_physical_device_group_properties);
typedef void (VKAPI_PTR *pfn_vk_get_image_memory_requirements2)(vk_device device, const vk_image_memory_requirements_info2* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_buffer_memory_requirements2)(vk_device device, const vk_buffer_memory_requirements_info2* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_image_sparse_memory_requirements2)(vk_device device, const vk_image_sparse_memory_requirements_info2* p_info, uint32_t* p_sparse_memory_requirement_count, vk_sparse_image_memory_requirements2* p_sparse_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_features2)(vk_physical_device physical_device, vk_physical_device_features2* p_features);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_properties2)(vk_physical_device physical_device, vk_physical_device_properties2* p_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_format_properties2)(vk_physical_device physical_device, vk_format format, vk_format_properties2* p_format_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties2)(vk_physical_device physical_device, const vk_physical_device_image_format_info2* p_image_format_info, vk_image_format_properties2* p_image_format_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_queue_family_properties2)(vk_physical_device physical_device, uint32_t* p_queue_family_property_count, vk_queue_family_properties2* p_queue_family_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_memory_properties2)(vk_physical_device physical_device, vk_physical_device_memory_properties2* p_memory_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties2)(vk_physical_device physical_device, const vk_physical_device_sparse_image_format_info2* p_format_info, uint32_t* p_property_count, vk_sparse_image_format_properties2* p_properties);
typedef void (VKAPI_PTR *pfn_vk_trim_command_pool)(vk_device device, vk_command_pool command_pool, vk_command_pool_trim_flags flags);
typedef void (VKAPI_PTR *pfn_vk_get_device_queue2)(vk_device device, const vk_device_queue_info2* p_queue_info, vk_queue* p_queue);
typedef vk_result (VKAPI_PTR *pfn_vk_create_sampler_ycbcr_conversion)(vk_device device, const vk_sampler_ycbcr_conversion_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_sampler_ycbcr_conversion* p_ycbcr_conversion);
typedef void (VKAPI_PTR *pfn_vk_destroy_sampler_ycbcr_conversion)(vk_device device, vk_sampler_ycbcr_conversion ycbcr_conversion, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_create_descriptor_update_template)(vk_device device, const vk_descriptor_update_template_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_descriptor_update_template* p_descriptor_update_template);
typedef void (VKAPI_PTR *pfn_vk_destroy_descriptor_update_template)(vk_device device, vk_descriptor_update_template descriptor_update_template, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_update_descriptor_set_with_template)(vk_device device, vk_descriptor_set descriptor_set, vk_descriptor_update_template descriptor_update_template, const void* p_data);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_buffer_properties)(vk_physical_device physical_device, const vk_physical_device_external_buffer_info* p_external_buffer_info, vk_external_buffer_properties* p_external_buffer_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_fence_properties)(vk_physical_device physical_device, const vk_physical_device_external_fence_info* p_external_fence_info, vk_external_fence_properties* p_external_fence_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_semaphore_properties)(vk_physical_device physical_device, const vk_physical_device_external_semaphore_info* p_external_semaphore_info, vk_external_semaphore_properties* p_external_semaphore_properties);
typedef void (VKAPI_PTR *pfn_vk_get_descriptor_set_layout_support)(vk_device device, const vk_descriptor_set_layout_create_info* p_create_info, vk_descriptor_set_layout_support* p_support);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_instance_version(
    uint32_t*                                   p_api_version) __asm("vkEnumerateInstanceVersion");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_buffer_memory2(
    vk_device                                    device,
    uint32_t                                    bind_info_count,
    const vk_bind_buffer_memory_info*               p_bind_infos) __asm("vkBindBufferMemory2");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_image_memory2(
    vk_device                                    device,
    uint32_t                                    bind_info_count,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_device_mask(
    vk_command_buffer                             command_buffer,
    uint32_t                                    device_mask) __asm("vkCmdSetDeviceMask");

VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch_base(
    vk_command_buffer                             command_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_get_image_sparse_memory_requirements2(
    vk_device                                    device,
    const vk_image_sparse_memory_requirements_info2* p_info,
    uint32_t*                                   p_sparse_memory_requirement_count,
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_features2(
    vk_physical_device                            physical_device,
    vk_physical_device_features2*                  p_features) __asm("vkGetPhysicalDeviceFeatures2");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_image_format_properties2(
    vk_physical_device                            physical_device,
    const vk_physical_device_image_format_info2*     p_image_format_info,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_descriptor_update_template(
    vk_device                                    device,
    const vk_descriptor_update_template_create_info* p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_descriptor_update_template(
    vk_device                                    device,
    vk_descriptor_update_template                  descriptor_update_template,
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_buffer_properties(
    vk_physical_device                            physical_device,
    const vk_physical_device_external_buffer_info*   p_external_buffer_info,
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_fence_properties(
    vk_physical_device                            physical_device,
    const vk_physical_device_external_fence_info*    p_external_fence_info,
...
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_semaphore_properties(
    vk_physical_device                            physical_device,
    const vk_physical_device_external_semaphore_info* p_external_semaphore_info,
    vk_external_semaphore_properties*              p_external_semaphore_properties) __asm("vkGetPhysicalDeviceExternalSemaphoreProperties");
...
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indirect_count)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);
typedef vk_result (VKAPI_PTR *pfn_vk_create_render_pass2)(vk_device device, const vk_render_pass_create_info2* p_create_info, const vk_allocation_callbacks* p_allocator, vk_render_pass* p_render_pass);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_render_pass2)(vk_command_buffer command_buffer, const vk_render_pass_begin_info*      p_render_pass_begin, const vk_subpass_begin_info*      p_subpass_begin_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_next_subpass2)(vk_command_buffer command_buffer, const vk_subpass_begin_info*      p_subpass_begin_info, const vk_subpass_end_info*        p_subpass_end_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_render_pass2)(vk_command_buffer command_buffer, const vk_subpass_end_info*        p_subpass_end_info);
typedef void (VKAPI_PTR *pfn_vk_reset_query_pool)(vk_device device, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count);
typedef vk_result (VKAPI_PTR *pfn_vk_get_semaphore_counter_value)(vk_device device, vk_semaphore semaphore, uint64_t* p_value);
typedef vk_result (VKAPI_PTR *pfn_vk_wait_semaphores)(vk_device device, const vk_semaphore_wait_info* p_wait_info, uint64_t timeout);
typedef vk_result (VKAPI_PTR *pfn_vk_signal_semaphore)(vk_device device, const vk_semaphore_signal_info* p_signal_info);
typedef vk_device_address (VKAPI_PTR *pfn_vk_get_buffer_device_address)(vk_device device, const vk_buffer_device_address_info* p_info);
typedef uint64_t (VKAPI_PTR *pfn_vk_get_buffer_opaque_capture_address)(vk_device device, const vk_buffer_device_address_info* p_info);
typedef uint64_t (VKAPI_PTR *pfn_vk_get_device_memory_opaque_capture_address)(vk_device device, const vk_device_memory_opaque_capture_address_info* p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indirect_count(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indexed_indirect_count(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    vk_buffer                                    count_buffer,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_render_pass2(
    vk_command_buffer                             command_buffer,
    const vk_subpass_end_info*                     p_subpass_end_info) __asm("vkCmdEndRenderPass2");

VKAPI_ATTR void VKAPI_CALL vk_reset_query_pool(
    vk_device                                    device,
    vk_query_pool                                 query_pool,
    uint32_t                                    first_query,
    uint32_t                                    query_count) __asm("vkResetQueryPool");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_semaphore_counter_value(
    vk_device                                    device,
    vk_semaphore                                 semaphore,
    uint64_t*                                   p_value) __asm("vkGetSemaphoreCounterValue");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_semaphores(
    vk_device                                    device,
    const vk_semaphore_wait_info*                  p_wait_info,
    uint64_t                                    timeout) __asm("vkWaitSemaphores");

VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore(
    vk_device                                    device,
    const vk_semaphore_signal_info*                p_signal_info) __asm("vkSignalSemaphore");

VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_buffer_device_address(
    vk_device                                    device,
    const vk_buffer_device_address_info*            p_info) __asm("vkGetBufferDeviceAddress");

VKAPI_ATTR uint64_t VKAPI_CALL vk_get_buffer_opaque_capture_address(
    vk_device                                    device,
    const vk_buffer_device_address_info*            p_info) __asm("vkGetBufferOpaqueCaptureAddress");
...
typedef void (VKAPI_PTR *pfn_vk_destroy_surface_khr)(vk_instance instance, vk_surface_khr surface, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_support_khr)(vk_physical_device physical_device, uint32_t queue_family_index, vk_surface_khr surface, vk_bool32* p_supported);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities_khr)(vk_physical_device physical_device, vk_surface_khr surface, vk_surface_capabilities_khr* p_surface_capabilities);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_formats_khr)(vk_physical_device physical_device, vk_surface_khr surface, uint32_t* p_surface_format_count, vk_surface_format_khr* p_surface_formats);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_present_modes_khr)(vk_physical_device physical_device, vk_surface_khr surface, uint32_t* p_present_mode_count, vk_present_mode_khr* p_present_modes);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_swapchain_khr)(vk_device device, const vk_swapchain_create_info_khr* p_create_info, const vk_allocation_callbacks* p_allocator, vk_swapchain_khr* p_swapchain);
typedef void (VKAPI_PTR *pfn_vk_destroy_swapchain_khr)(vk_device device, vk_swapchain_khr swapchain, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_get_swapchain_images_khr)(vk_device device, vk_swapchain_khr swapchain, uint32_t* p_swapchain_image_count, vk_image* p_swapchain_images);
typedef vk_result (VKAPI_PTR *pfn_vk_acquire_next_image_khr)(vk_device device, vk_swapchain_khr swapchain, uint64_t timeout, vk_semaphore semaphore, vk_fence fence, uint32_t* p_image_index);
typedef vk_result (VKAPI_PTR *pfn_vk_queue_present_khr)(vk_queue queue, const vk_present_info_khr* p_present_info);
typedef vk_result (VKAPI_PTR *pfn_vk_get_device_group_present_capabilities_khr)(vk_device device, vk_device_group_present_capabilities_khr* p_device_group_present_capabilities);
typedef vk_result (VKAPI_PTR *pfn_vk_get_device_group_surface_present_modes_khr)(vk_device device, vk_surface_khr surface, vk_device_group_present_mode_flags_khr* p_modes);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_present_rectangles_khr)(vk_physical_device physical_device, vk_surface_khr surface, uint32_t* p_rect_count, vk_rect2d* p_rects);
typedef vk_result (VKAPI_PTR *pfn_vk_acquire_next_image2khr)(vk_device device, const vk_acquire_next_image_info_khr* p_acquire_info, uint32_t* p_image_index);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_swapchain_khr(
    vk_device                                    device,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_swapchain_images_khr(
    vk_device                                    device,
    vk_swapchain_khr                              swapchain,
    uint32_t*                                   p_swapchain_image_count,
    vk_image*                                    p_swapchain_images) __asm("vkGetSwapchainImagesKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_next_image_khr(
    vk_device                                    device,
    vk_swapchain_khr                              swapchain,
    uint64_t                                    timeout,
    vk_semaphore                                 semaphore,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_queue_present_khr(
    vk_queue                                     queue,
    const vk_present_info_khr*                     p_present_info) __asm("vkQueuePresentKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_device_group_present_capabilities_khr(
    vk_device                                    device,
    vk_device_group_present_capabilities_khr*        p_device_group_present_capabilities) __asm("vkGetDeviceGroupPresentCapabilitiesKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_next_image2khr(
    vk_device                                    device,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_display_properties_khr)(vk_physical_device physical_device, uint32_t* p_property_count, vk_display_properties_khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_display_plane_properties_khr)(vk_physical_device physical_device, uint32_t* p_property_count, vk_display_plane_properties_khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_display_plane_supported_displays_khr)(vk_physical_device physical_device, uint32_t plane_index, uint32_t* p_display_count, vk_display_khr* p_displays);
typedef vk_result (VKAPI_PTR *pfn_vk_get_display_mode_properties_khr)(vk_physical_device physical_device, vk_display_khr display, uint32_t* p_property_count, vk_display_mode_properties_khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_create_display_mode_khr)(vk_physical_device physical_device, vk_display_khr display, const vk_display_mode_create_info_khr* p_create_info, const vk_allocation_callbacks* p_allocator, vk_display_mode_khr* p_mode);
typedef vk_result (VKAPI_PTR *pfn_vk_get_display_plane_capabilities_khr)(vk_physical_device physical_device, vk_display_mode_khr mode, uint32_t plane_index, vk_display_plane_capabilities_khr* p_capabilities);
typedef vk_result (VKAPI_PTR *pfn_vk_create_display_plane_surface_khr)(vk_instance instance, const vk_display_surface_create_info_khr* p_create_info, const vk_allocation_callbacks* p_allocator, vk_surface_khr* p_surface);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_display_mode_khr(
    vk_physical_device                            physical_device,
    vk_display_khr                                display,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_display_plane_surface_khr(
    vk_instance                                  instance,
    const vk_display_surface_create_info_khr*        p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_surface_khr*                               p_surface) __asm("vkCreateDisplayPlaneSurfaceKHR");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_shared_swapchains_khr)(vk_device device, uint32_t swapchain_count, const vk_swapchain_create_info_khr* p_create_infos, const vk_allocation_callbacks* p_allocator, vk_swapchain_khr* p_swapchains);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_shared_swapchains_khr(
    ...
    const vk_allocation_callbacks*                p_allocator,
    vk_swapchain_khr*                             p_swapchains) __asm("vkCreateSharedSwapchainsKHR");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_features2khr)(vk_physical_device physical_device, vk_physical_device_features2* p_features);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_properties2khr)(vk_physical_device physical_device, vk_physical_device_properties2* p_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_format_properties2khr)(vk_physical_device physical_device, vk_format format, vk_format_properties2* p_format_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_image_format_properties2khr)(vk_physical_device physical_device, const vk_physical_device_image_format_info2* p_image_format_info, vk_image_format_properties2* p_image_format_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_queue_family_properties2khr)(vk_physical_device physical_device, uint32_t* p_queue_family_property_count, vk_queue_family_properties2* p_queue_family_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_memory_properties2khr)(vk_physical_device physical_device, vk_physical_device_memory_properties2* p_memory_properties);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_sparse_image_format_properties2khr)(vk_physical_device physical_device, const vk_physical_device_sparse_image_format_info2* p_format_info, uint32_t* p_property_count, vk_sparse_image_format_properties2* p_properties);
...
typedef void (VKAPI_PTR *pfn_vk_get_device_group_peer_memory_features_khr)(vk_device device, uint32_t heap_index, uint32_t local_device_index, uint32_t remote_device_index, vk_peer_memory_feature_flags* p_peer_memory_features);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_device_mask_khr)(vk_command_buffer command_buffer, uint32_t device_mask);
typedef void (VKAPI_PTR *pfn_vk_cmd_dispatch_base_khr)(vk_command_buffer command_buffer, uint32_t base_group_x, uint32_t base_group_y, uint32_t base_group_z, uint32_t group_count_x, uint32_t group_count_y, uint32_t group_count_z);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_device_mask_khr(
    vk_command_buffer                             command_buffer,
    uint32_t                                    device_mask) __asm("vkCmdSetDeviceMaskKHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_dispatch_base_khr(
    vk_command_buffer                             command_buffer,
    uint32_t                                    base_group_x,
    uint32_t                                    base_group_y,
    uint32_t                                    base_group_z,
...
typedef void (VKAPI_PTR *pfn_vk_trim_command_pool_khr)(vk_device device, vk_command_pool command_pool, vk_command_pool_trim_flags flags);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_trim_command_pool_khr(
    vk_device                                    device,
    vk_command_pool                               command_pool,
...
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_physical_device_groups_khr)(vk_instance instance, uint32_t* p_physical_device_group_count, vk_physical_device_group_properties* p_physical_device_group_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_physical_device_groups_khr(
    vk_instance                                  instance,
    uint32_t*                                   p_physical_device_group_count,
    vk_physical_device_group_properties*            p_physical_device_group_properties) __asm("vkEnumeratePhysicalDeviceGroupsKHR");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_buffer_properties_khr)(vk_physical_device physical_device, const vk_physical_device_external_buffer_info* p_external_buffer_info, vk_external_buffer_properties* p_external_buffer_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_buffer_properties_khr(
    vk_physical_device                            physical_device,
    const vk_physical_device_external_buffer_info*   p_external_buffer_info,
    vk_external_buffer_properties*                 p_external_buffer_properties) __asm("vkGetPhysicalDeviceExternalBufferPropertiesKHR");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_memory_fd_khr)(vk_device device, const vk_memory_get_fd_info_khr* p_get_fd_info, int* p_fd);
typedef vk_result (VKAPI_PTR *pfn_vk_get_memory_fd_properties_khr)(vk_device device, vk_external_memory_handle_type_flag_bits handle_type, int fd, vk_memory_fd_properties_khr* p_memory_fd_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_memory_fd_khr(
    vk_device                                    device,
    const vk_memory_get_fd_info_khr*                 p_get_fd_info,
...
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_semaphore_properties_khr)(vk_physical_device physical_device, const vk_physical_device_external_semaphore_info* p_external_semaphore_info, vk_external_semaphore_properties* p_external_semaphore_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_get_physical_device_external_semaphore_properties_khr(
    vk_physical_device                            physical_device,
    const vk_physical_device_external_semaphore_info* p_external_semaphore_info,
    vk_external_semaphore_properties*              p_external_semaphore_properties) __asm("vkGetPhysicalDeviceExternalSemaphorePropertiesKHR");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_import_semaphore_fd_khr)(vk_device device, const vk_import_semaphore_fd_info_khr* p_import_semaphore_fd_info);
typedef vk_result (VKAPI_PTR *pfn_vk_get_semaphore_fd_khr)(vk_device device, const vk_semaphore_get_fd_info_khr* p_get_fd_info, int* p_fd);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_semaphore_fd_khr(
    vk_device                                    device,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_push_descriptor_set_khr)(vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point, vk_pipeline_layout layout, uint32_t set, uint32_t descriptor_write_count, const vk_write_descriptor_set* p_descriptor_writes);
typedef void (VKAPI_PTR *pfn_vk_cmd_push_descriptor_set_with_template_khr)(vk_command_buffer command_buffer, vk_descriptor_update_template descriptor_update_template, vk_pipeline_layout layout, uint32_t set, const void* p_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_push_descriptor_set_khr(
    vk_command_buffer                             command_buffer,
    vk_pipeline_bind_point                         pipeline_bind_point,
    vk_pipeline_layout                            layout,
    uint32_t                                    set,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_push_descriptor_set_with_template_khr(
    ...
    vk_pipeline_layout                            layout,
    uint32_t                                    set,
    const void*                                 p_data) __asm("vkCmdPushDescriptorSetWithTemplateKHR");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_descriptor_update_template_khr)(vk_device device, const vk_descriptor_update_template_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_descriptor_update_template* p_descriptor_update_template);
typedef void (VKAPI_PTR *pfn_vk_destroy_descriptor_update_template_khr)(vk_device device, vk_descriptor_update_template descriptor_update_template, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_update_descriptor_set_with_template_khr)(vk_device device, vk_descriptor_set descriptor_set, vk_descriptor_update_template descriptor_update_template, const void* p_data);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_render_pass2khr)(vk_device device, const vk_render_pass_create_info2* p_create_info, const vk_allocation_callbacks* p_allocator, vk_render_pass* p_render_pass);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_render_pass2khr)(vk_command_buffer command_buffer, const vk_render_pass_begin_info*      p_render_pass_begin, const vk_subpass_begin_info*      p_subpass_begin_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_next_subpass2khr)(vk_command_buffer command_buffer, const vk_subpass_begin_info*      p_subpass_begin_info, const vk_subpass_end_info*        p_subpass_end_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_render_pass2khr)(vk_command_buffer command_buffer, const vk_subpass_end_info*        p_subpass_end_info);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_render_pass2khr(
    vk_command_buffer                             command_buffer,
    const vk_render_pass_begin_info*                p_render_pass_begin,
    const vk_subpass_begin_info*                   p_subpass_begin_info) __asm("vkCmdBeginRenderPass2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_next_subpass2khr(
    vk_command_buffer                             command_buffer,
    const vk_subpass_begin_info*                   p_subpass_begin_info,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_render_pass2khr(
    vk_command_buffer                             command_buffer,
    const vk_subpass_end_info*                     p_subpass_end_info) __asm("vkCmdEndRenderPass2KHR");
#endif
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_swapchain_status_khr(
    vk_device                                    device,
    vk_swapchain_khr                              swapchain) __asm("vkGetSwapchainStatusKHR");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_external_fence_properties_khr)(vk_physical_device physical_device, const vk_physical_device_external_fence_info* p_external_fence_info, vk_external_fence_properties* p_external_fence_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_import_fence_fd_khr)(vk_device device, const vk_import_fence_fd_info_khr* p_import_fence_fd_info);
typedef vk_result (VKAPI_PTR *pfn_vk_get_fence_fd_khr)(vk_device device, const vk_fence_get_fd_info_khr* p_get_fd_info, int* p_fd);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_import_fence_fd_khr(
    vk_device                                    device,
    const vk_import_fence_fd_info_khr*               p_import_fence_fd_info) __asm("vkImportFenceFdKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_fence_fd_khr(
    vk_device                                    device,
    const vk_fence_get_fd_info_khr*                  p_get_fd_info,
...
typedef vk_result (VKAPI_PTR *pfn_vk_enumerate_physical_device_queue_family_performance_query_counters_khr)(vk_physical_device physical_device, uint32_t queue_family_index, uint32_t* p_counter_count, vk_performance_counter_khr* p_counters, vk_performance_counter_description_khr* p_counter_descriptions);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_queue_family_performance_query_passes_khr)(vk_physical_device physical_device, const vk_query_pool_performance_create_info_khr* p_performance_query_create_info, uint32_t* p_num_passes);
typedef vk_result (VKAPI_PTR *pfn_vk_acquire_profiling_lock_khr)(vk_device device, const vk_acquire_profiling_lock_info_khr* p_info);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_enumerate_physical_device_queue_family_performance_query_counters_khr(
    vk_physical_device                            physical_device,
    uint32_t                                    queue_family_index,
    uint32_t*                                   p_counter_count,
    vk_performance_counter_khr*                    p_counters,
    vk_performance_counter_description_khr*         p_counter_descriptions) __asm("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_profiling_lock_khr(
    vk_device                                    device,
    const vk_acquire_profiling_lock_info_khr*        p_info) __asm("vkAcquireProfilingLockKHR");

VKAPI_ATTR void VKAPI_CALL vk_release_profiling_lock_khr(
    vk_device                                    device) __asm("vkReleaseProfilingLockKHR");
#endif
...
typedef vk_pipeline_tessellation_domain_origin_state_create_info vk_pipeline_tessellation_domain_origin_state_create_info_khr;
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities2khr)(vk_physical_device physical_device, const vk_physical_device_surface_info2khr* p_surface_info, vk_surface_capabilities2khr* p_surface_capabilities);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_formats2khr)(vk_physical_device physical_device, const vk_physical_device_surface_info2khr* p_surface_info, uint32_t* p_surface_format_count, vk_surface_format2khr* p_surface_formats);
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_display_properties2khr)(vk_physical_device physical_device, uint32_t* p_property_count, vk_display_properties2khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_display_plane_properties2khr)(vk_physical_device physical_device, uint32_t* p_property_count, vk_display_plane_properties2khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_display_mode_properties2khr)(vk_physical_device physical_device, vk_display_khr display, uint32_t* p_property_count, vk_display_mode_properties2khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_display_plane_capabilities2khr)(vk_physical_device physical_device, const vk_display_plane_info2khr* p_display_plane_info, vk_display_plane_capabilities2khr* p_capabilities);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_display_plane_capabilities2khr(
    vk_physical_device                            physical_device,
    const vk_display_plane_info2khr*               p_display_plane_info,
...
typedef void (VKAPI_PTR *pfn_vk_get_image_memory_requirements2khr)(vk_device device, const vk_image_memory_requirements_info2* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_buffer_memory_requirements2khr)(vk_device device, const vk_buffer_memory_requirements_info2* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_get_image_sparse_memory_requirements2khr)(vk_device device, const vk_image_sparse_memory_requirements_info2* p_info, uint32_t* p_sparse_memory_requirement_count, vk_sparse_image_memory_requirements2* p_sparse_memory_requirements);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_sampler_ycbcr_conversion_khr)(vk_device device, const vk_sampler_ycbcr_conversion_create_info* p_create_info, const vk_allocation_callbacks* p_allocator, vk_sampler_ycbcr_conversion* p_ycbcr_conversion);
typedef void (VKAPI_PTR *pfn_vk_destroy_sampler_ycbcr_conversion_khr)(vk_device device, vk_sampler_ycbcr_conversion ycbcr_conversion, const vk_allocation_callbacks* p_allocator);
...
typedef vk_result (VKAPI_PTR *pfn_vk_bind_buffer_memory2khr)(vk_device device, uint32_t bind_info_count, const vk_bind_buffer_memory_info* p_bind_infos);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_image_memory2khr)(vk_device device, uint32_t bind_info_count, const vk_bind_image_memory_info* p_bind_infos);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_bind_buffer_memory2khr(
    vk_device                                    device,
    uint32_t                                    bind_info_count,
    const vk_bind_buffer_memory_info*               p_bind_infos) __asm("vkBindBufferMemory2KHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_bind_image_memory2khr(
    vk_device                                    device,
    uint32_t                                    bind_info_count,
...
typedef void (VKAPI_PTR *pfn_vk_get_descriptor_set_layout_support_khr)(vk_device device, const vk_descriptor_set_layout_create_info* p_create_info, vk_descriptor_set_layout_support* p_support);
...
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_khr)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count_khr)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indirect_count_khr(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    vk_buffer                                    count_buffer,
...
typedef vk_physical_device_shader_subgroup_extended_types_features vk_physical_device_shader_subgroup_extended_types_features_khr;
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_semaphore_counter_value_khr)(vk_device device, vk_semaphore semaphore, uint64_t* p_value);
typedef vk_result (VKAPI_PTR *pfn_vk_wait_semaphores_khr)(vk_device device, const vk_semaphore_wait_info* p_wait_info, uint64_t timeout);
typedef vk_result (VKAPI_PTR *pfn_vk_signal_semaphore_khr)(vk_device device, const vk_semaphore_signal_info* p_signal_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_semaphore_counter_value_khr(
    vk_device                                    device,
    vk_semaphore                                 semaphore,
    uint64_t*                                   p_value) __asm("vkGetSemaphoreCounterValueKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_wait_semaphores_khr(
    vk_device                                    device,
    const vk_semaphore_wait_info*                  p_wait_info,
    uint64_t                                    timeout) __asm("vkWaitSemaphoresKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_signal_semaphore_khr(
    vk_device                                    device,
    const vk_semaphore_signal_info*                p_signal_info) __asm("vkSignalSemaphoreKHR");
#endif
...
typedef vk_physical_device_separate_depth_stencil_layouts_features vk_physical_device_separate_depth_stencil_layouts_features_khr;
...
typedef vk_physical_device_uniform_buffer_standard_layout_features vk_physical_device_uniform_buffer_standard_layout_features_khr;
...
typedef vk_device_address (VKAPI_PTR *pfn_vk_get_buffer_device_address_khr)(vk_device device, const vk_buffer_device_address_info* p_info);
typedef uint64_t (VKAPI_PTR *pfn_vk_get_buffer_opaque_capture_address_khr)(vk_device device, const vk_buffer_device_address_info* p_info);
typedef uint64_t (VKAPI_PTR *pfn_vk_get_device_memory_opaque_capture_address_khr)(vk_device device, const vk_device_memory_opaque_capture_address_info* p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_buffer_device_address_khr(
    vk_device                                    device,
    const vk_buffer_device_address_info*            p_info) __asm("vkGetBufferDeviceAddressKHR");

VKAPI_ATTR uint64_t VKAPI_CALL vk_get_buffer_opaque_capture_address_khr(
    vk_device                                    device,
    const vk_buffer_device_address_info*            p_info) __asm("vkGetBufferOpaqueCaptureAddressKHR");
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_pipeline_executable_properties_khr)(vk_device                        device, const vk_pipeline_info_khr*        p_pipeline_info, uint32_t* p_executable_count, vk_pipeline_executable_properties_khr* p_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_pipeline_executable_statistics_khr)(vk_device                        device, const vk_pipeline_executable_info_khr*  p_executable_info, uint32_t* p_statistic_count, vk_pipeline_executable_statistic_khr* p_statistics);
typedef vk_result (VKAPI_PTR *pfn_vk_get_pipeline_executable_internal_representations_khr)(vk_device                        device, const vk_pipeline_executable_info_khr*  p_executable_info, uint32_t* p_internal_representation_count, vk_pipeline_executable_internal_representation_khr* p_internal_representations);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_executable_properties_khr(
    vk_device                                    device,
    const vk_pipeline_info_khr*                    p_pipeline_info,
    uint32_t*                                   p_executable_count,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_executable_statistics_khr(
    vk_device                                    device,
    const vk_pipeline_executable_info_khr*          p_executable_info,
    uint32_t*                                   p_statistic_count,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_pipeline_executable_internal_representations_khr(
    ...
    vk_pipeline_executable_internal_representation_khr* p_internal_representations) __asm("vkGetPipelineExecutableInternalRepresentationsKHR");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_buffer2khr)(vk_command_buffer command_buffer, const vk_copy_buffer_info2khr* p_copy_buffer_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_image2khr)(vk_command_buffer command_buffer, const vk_copy_image_info2khr* p_copy_image_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_buffer_to_image2khr)(vk_command_buffer command_buffer, const vk_copy_buffer_to_image_info2khr* p_copy_buffer_to_image_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_image_to_buffer2khr)(vk_command_buffer command_buffer, const vk_copy_image_to_buffer_info2khr* p_copy_image_to_buffer_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_blit_image2khr)(vk_command_buffer command_buffer, const vk_blit_image_info2khr* p_blit_image_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_resolve_image2khr)(vk_command_buffer command_buffer, const vk_resolve_image_info2khr* p_resolve_image_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_buffer2khr(
    vk_command_buffer                             command_buffer,
    const vk_copy_buffer_info2khr*                 p_copy_buffer_info) __asm("vkCmdCopyBuffer2KHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_copy_image2khr(
    vk_command_buffer                             command_buffer,
    const vk_copy_image_info2khr*                  p_copy_image_info) __asm("vkCmdCopyImage2KHR");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_blit_image2khr(
    vk_command_buffer                             command_buffer,
    const vk_blit_image_info2khr*                  p_blit_image_info) __asm("vkCmdBlitImage2KHR");
...
typedef vk_bool32 (VKAPI_PTR *pfn_vk_debug_report_callback_ext)(
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_debug_report_callback_ext)(vk_instance instance, const vk_debug_report_callback_create_info_ext* p_create_info, const vk_allocation_callbacks* p_allocator, vk_debug_report_callback_ext* p_callback);
typedef void (VKAPI_PTR *pfn_vk_destroy_debug_report_callback_ext)(vk_instance instance, vk_debug_report_callback_ext callback, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_debug_report_message_ext)(vk_instance instance, vk_debug_report_flags_ext flags, vk_debug_report_object_type_ext object_type, uint64_t object, size_t location, int32_t message_code, const char* p_layer_prefix, const char* p_message);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_debug_report_callback_ext(
    vk_instance                                  instance,
    const vk_debug_report_callback_create_info_ext*   p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_debug_report_message_ext(
    vk_instance                                  instance,
    vk_debug_report_flags_ext                       flags,
    vk_debug_report_object_type_ext                  object_type,
    uint64_t                                    object,
...
typedef vk_result (VKAPI_PTR *pfn_vk_debug_marker_set_object_tag_ext)(vk_device device, const vk_debug_marker_object_tag_info_ext* p_tag_info);
typedef vk_result (VKAPI_PTR *pfn_vk_debug_marker_set_object_name_ext)(vk_device device, const vk_debug_marker_object_name_info_ext* p_name_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_debug_marker_begin_ext)(vk_command_buffer command_buffer, const vk_debug_marker_marker_info_ext* p_marker_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_debug_marker_end_ext)(vk_command_buffer command_buffer);
typedef void (VKAPI_PTR *pfn_vk_cmd_debug_marker_insert_ext)(vk_command_buffer command_buffer, const vk_debug_marker_marker_info_ext* p_marker_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_debug_marker_set_object_tag_ext(
    vk_device                                    device,
    const vk_debug_marker_object_tag_info_ext*        p_tag_info) __asm("vkDebugMarkerSetObjectTagEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_debug_marker_set_object_name_ext(
    vk_device                                    device,
    const vk_debug_marker_object_name_info_ext*       p_name_info) __asm("vkDebugMarkerSetObjectNameEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_debug_marker_end_ext(
    vk_command_buffer                             command_buffer) __asm("vkCmdDebugMarkerEndEXT");
...
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_transform_feedback_buffers_ext)(vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count, const vk_buffer* p_buffers, const vk_device_size* p_offsets, const vk_device_size* p_sizes);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_transform_feedback_ext)(vk_command_buffer command_buffer, uint32_t first_counter_buffer, uint32_t counter_buffer_count, const vk_buffer* p_counter_buffers, const vk_device_size* p_counter_buffer_offsets);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_transform_feedback_ext)(vk_command_buffer command_buffer, uint32_t first_counter_buffer, uint32_t counter_buffer_count, const vk_buffer* p_counter_buffers, const vk_device_size* p_counter_buffer_offsets);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_query_indexed_ext)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query, vk_query_control_flags flags, uint32_t index);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_query_indexed_ext)(vk_command_buffer command_buffer, vk_query_pool query_pool, uint32_t query, uint32_t index);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indirect_byte_count_ext)(vk_command_buffer command_buffer, uint32_t instance_count, uint32_t first_instance, vk_buffer counter_buffer, vk_device_size counter_buffer_offset, uint32_t counter_offset, uint32_t vertex_stride);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_transform_feedback_buffers_ext(
    ...
    const vk_device_size*                         p_sizes) __asm("vkCmdBindTransformFeedbackBuffersEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_transform_feedback_ext(
    vk_command_buffer                             command_buffer,
    uint32_t                                    first_counter_buffer,
    uint32_t                                    counter_buffer_count,
    const vk_buffer*                             p_counter_buffers,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_query_indexed_ext(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    query,
    vk_query_control_flags                         flags,
    uint32_t                                    index) __asm("vkCmdBeginQueryIndexedEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_query_indexed_ext(
    vk_command_buffer                             command_buffer,
    vk_query_pool                                 query_pool,
    uint32_t                                    query,
...
typedef uint32_t (VKAPI_PTR *pfn_vk_get_image_view_handle_nvx)(vk_device device, const vk_image_view_handle_info_nvx* p_info);
typedef vk_result (VKAPI_PTR *pfn_vk_get_image_view_address_nvx)(vk_device device, vk_image_view image_view, vk_image_view_address_properties_nvx* p_properties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR uint32_t VKAPI_CALL vk_get_image_view_handle_nvx(
    vk_device                                    device,
    const vk_image_view_handle_info_nvx*             p_info) __asm("vkGetImageViewHandleNVX");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_image_view_address_nvx(
    vk_device                                    device,
    vk_image_view                                 image_view,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indirect_count_amd)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_indexed_indirect_count_amd)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_indirect_count_amd(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    vk_buffer                                    count_buffer,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_shader_info_amd)(vk_device device, vk_pipeline pipeline, vk_shader_stage_flag_bits shader_stage, vk_shader_info_type_amd info_type, size_t* p_info_size, void* p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_shader_info_amd(
    vk_device                                    device,
    vk_pipeline                                  pipeline,
    vk_shader_stage_flag_bits                       shader_stage,
    vk_shader_info_type_amd                         info_type,
    size_t*                                     p_info_size,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_external_image_format_properties_nv)(vk_physical_device physical_device, vk_format format, vk_image_type type, vk_image_tiling tiling, vk_image_usage_flags usage, vk_image_create_flags flags, vk_external_memory_handle_type_flags_nv external_handle_type, vk_external_image_format_properties_nv* p_external_image_format_properties);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_external_image_format_properties_nv(
    ...
    vk_external_image_format_properties_nv*          p_external_image_format_properties) __asm("vkGetPhysicalDeviceExternalImageFormatPropertiesNV");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_conditional_rendering_ext)(vk_command_buffer command_buffer, const vk_conditional_rendering_begin_info_ext* p_conditional_rendering_begin);
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_begin_conditional_rendering_ext(
    vk_command_buffer                             command_buffer,
    const vk_conditional_rendering_begin_info_ext*   p_conditional_rendering_begin) __asm("vkCmdBeginConditionalRenderingEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_end_conditional_rendering_ext(
    vk_command_buffer                             command_buffer) __asm("vkCmdEndConditionalRenderingEXT");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_viewport_wscaling_nv)(vk_command_buffer command_buffer, uint32_t first_viewport, uint32_t viewport_count, const vk_viewport_wscaling_nv* p_viewport_wscalings);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_release_display_ext(
    vk_physical_device                            physical_device,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_surface_capabilities2ext)(vk_physical_device physical_device, vk_surface_khr surface, vk_surface_capabilities2ext* p_surface_capabilities);
...
typedef vk_result (VKAPI_PTR *pfn_vk_display_power_control_ext)(vk_device device, vk_display_khr display, const vk_display_power_info_ext* p_display_power_info);
typedef vk_result (VKAPI_PTR *pfn_vk_register_device_event_ext)(vk_device device, const vk_device_event_info_ext* p_device_event_info, const vk_allocation_callbacks* p_allocator, vk_fence* p_fence);
typedef vk_result (VKAPI_PTR *pfn_vk_register_display_event_ext)(vk_device device, vk_display_khr display, const vk_display_event_info_ext* p_display_event_info, const vk_allocation_callbacks* p_allocator, vk_fence* p_fence);
typedef vk_result (VKAPI_PTR *pfn_vk_get_swapchain_counter_ext)(vk_device device, vk_swapchain_khr swapchain, vk_surface_counter_flag_bits_ext counter, uint64_t* p_counter_value);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_display_power_control_ext(
    vk_device                                    device,
    vk_display_khr                                display,
    const vk_display_power_info_ext*                p_display_power_info) __asm("vkDisplayPowerControlEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_register_device_event_ext(
    vk_device                                    device,
    const vk_device_event_info_ext*                 p_device_event_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_fence*                                    p_fence) __asm("vkRegisterDeviceEventEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_register_display_event_ext(
    vk_device                                    device,
    vk_display_khr                                display,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_swapchain_counter_ext(
    vk_device                                    device,
    vk_swapchain_khr                              swapchain,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_refresh_cycle_duration_google)(vk_device device, vk_swapchain_khr swapchain, vk_refresh_cycle_duration_google* p_display_timing_properties);
typedef vk_result (VKAPI_PTR *pfn_vk_get_past_presentation_timing_google)(vk_device device, vk_swapchain_khr swapchain, uint32_t* p_presentation_timing_count, vk_past_presentation_timing_google* p_presentation_timings);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_past_presentation_timing_google(
    vk_device                                    device,
    vk_swapchain_khr                              swapchain,
    uint32_t*                                   p_presentation_timing_count,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_discard_rectangle_ext)(vk_command_buffer command_buffer, uint32_t first_discard_rectangle, uint32_t discard_rectangle_count, const vk_rect2d* p_discard_rectangles);
...
typedef void (VKAPI_PTR *pfn_vk_set_hdr_metadata_ext)(vk_device device, uint32_t swapchain_count, const vk_swapchain_khr* p_swapchains, const vk_hdr_metadata_ext* p_metadata);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_set_hdr_metadata_ext(
    vk_device                                    device,
    uint32_t                                    swapchain_count,
    const vk_swapchain_khr*                       p_swapchains,
...
typedef vk_bool32 (VKAPI_PTR *pfn_vk_debug_utils_messenger_callback_ext)(
    vk_debug_utils_message_severity_flag_bits_ext           message_severity,
...
typedef vk_result (VKAPI_PTR *pfn_vk_set_debug_utils_object_name_ext)(vk_device device, const vk_debug_utils_object_name_info_ext* p_name_info);
typedef vk_result (VKAPI_PTR *pfn_vk_set_debug_utils_object_tag_ext)(vk_device device, const vk_debug_utils_object_tag_info_ext* p_tag_info);
typedef void (VKAPI_PTR *pfn_vk_queue_begin_debug_utils_label_ext)(vk_queue queue, const vk_debug_utils_label_ext* p_label_info);
typedef void (VKAPI_PTR *pfn_vk_queue_end_debug_utils_label_ext)(vk_queue queue);
typedef void (VKAPI_PTR *pfn_vk_queue_insert_debug_utils_label_ext)(vk_queue queue, const vk_debug_utils_label_ext* p_label_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_begin_debug_utils_label_ext)(vk_command_buffer command_buffer, const vk_debug_utils_label_ext* p_label_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_end_debug_utils_label_ext)(vk_command_buffer command_buffer);
typedef void (VKAPI_PTR *pfn_vk_cmd_insert_debug_utils_label_ext)(vk_command_buffer command_buffer, const vk_debug_utils_label_ext* p_label_info);
typedef vk_result (VKAPI_PTR *pfn_vk_create_debug_utils_messenger_ext)(vk_instance instance, const vk_debug_utils_messenger_create_info_ext* p_create_info, const vk_allocation_callbacks* p_allocator, vk_debug_utils_messenger_ext* p_messenger);
typedef void (VKAPI_PTR *pfn_vk_destroy_debug_utils_messenger_ext)(vk_instance instance, vk_debug_utils_messenger_ext messenger, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_submit_debug_utils_message_ext)(vk_instance instance, vk_debug_utils_message_severity_flag_bits_ext message_severity, vk_debug_utils_message_type_flags_ext message_types, const vk_debug_utils_messenger_callback_data_ext* p_callback_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_set_debug_utils_object_name_ext(
    vk_device                                    device,
    const vk_debug_utils_object_name_info_ext*        p_name_info) __asm("vkSetDebugUtilsObjectNameEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_set_debug_utils_object_tag_ext(
    vk_device                                    device,
    const vk_debug_utils_object_tag_info_ext*         p_tag_info) __asm("vkSetDebugUtilsObjectTagEXT");

VKAPI_ATTR void VKAPI_CALL vk_queue_begin_debug_utils_label_ext(
    vk_queue                                     queue,
    const vk_debug_utils_label_ext*                 p_label_info) __asm("vkQueueBeginDebugUtilsLabelEXT");

VKAPI_ATTR void VKAPI_CALL vk_queue_end_debug_utils_label_ext(
    vk_queue                                     queue) __asm("vkQueueEndDebugUtilsLabelEXT");

VKAPI_ATTR void VKAPI_CALL vk_queue_insert_debug_utils_label_ext(
    vk_queue                                     queue,
    const vk_debug_utils_label_ext*                 p_label_info) __asm("vkQueueInsertDebugUtilsLabelEXT");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_end_debug_utils_label_ext(
    vk_command_buffer                             command_buffer) __asm("vkCmdEndDebugUtilsLabelEXT");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_debug_utils_messenger_ext(
    vk_instance                                  instance,
    const vk_debug_utils_messenger_create_info_ext*   p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_sample_locations_ext)(vk_command_buffer command_buffer, const vk_sample_locations_info_ext* p_sample_locations_info);
typedef void (VKAPI_PTR *pfn_vk_get_physical_device_multisample_properties_ext)(vk_physical_device physical_device, vk_sample_count_flag_bits samples, vk_multisample_properties_ext* p_multisample_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_image_drm_format_modifier_properties_ext)(vk_device device, vk_image image, vk_image_drm_format_modifier_properties_ext* p_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_validation_cache_ext)(vk_device device, const vk_validation_cache_create_info_ext* p_create_info, const vk_allocation_callbacks* p_allocator, vk_validation_cache_ext* p_validation_cache);
typedef void (VKAPI_PTR *pfn_vk_destroy_validation_cache_ext)(vk_device device, vk_validation_cache_ext validation_cache, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_merge_validation_caches_ext)(vk_device device, vk_validation_cache_ext dst_cache, uint32_t src_cache_count, const vk_validation_cache_ext* p_src_caches);
typedef vk_result (VKAPI_PTR *pfn_vk_get_validation_cache_data_ext)(vk_device device, vk_validation_cache_ext validation_cache, size_t* p_data_size, void* p_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_validation_cache_ext(
    vk_device                                    device,
    const vk_validation_cache_create_info_ext*       p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_validation_cache_ext*                       p_validation_cache) __asm("vkCreateValidationCacheEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_validation_cache_ext(
    vk_device                                    device,
    vk_validation_cache_ext                        validation_cache,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyValidationCacheEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_merge_validation_caches_ext(
    vk_device                                    device,
    vk_validation_cache_ext                        dst_cache,
    uint32_t                                    src_cache_count,
    const vk_validation_cache_ext*                 p_src_caches) __asm("vkMergeValidationCachesEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_validation_cache_data_ext(
    vk_device                                    device,
    vk_validation_cache_ext                        validation_cache,
    size_t*                                     p_data_size,
...
typedef vk_descriptor_set_variable_descriptor_count_allocate_info vk_descriptor_set_variable_descriptor_count_allocate_info_ext;

typedef vk_descriptor_set_variable_descriptor_count_layout_support vk_descriptor_set_variable_descriptor_count_layout_support_ext;
...
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_shading_rate_image_nv)(vk_command_buffer command_buffer, vk_image_view image_view, vk_image_layout image_layout);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_viewport_shading_rate_palette_nv)(vk_command_buffer command_buffer, uint32_t first_viewport, uint32_t viewport_count, const vk_shading_rate_palette_nv* p_shading_rate_palettes);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_coarse_sample_order_nv)(vk_command_buffer command_buffer, vk_coarse_sample_order_type_nv sample_order_type, uint32_t custom_sample_order_count, const vk_coarse_sample_order_custom_nv* p_custom_sample_orders);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_bind_shading_rate_image_nv(
    vk_command_buffer                             command_buffer,
    vk_image_view                                 image_view,
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_acceleration_structure_nv)(vk_device device, const vk_acceleration_structure_create_info_nv* p_create_info, const vk_allocation_callbacks* p_allocator, vk_acceleration_structure_nv* p_acceleration_structure);
typedef void (VKAPI_PTR *pfn_vk_destroy_acceleration_structure_khr)(vk_device device, vk_acceleration_structure_khr acceleration_structure, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_destroy_acceleration_structure_nv)(vk_device device, vk_acceleration_structure_khr acceleration_structure, const vk_allocation_callbacks* p_allocator);
typedef void (VKAPI_PTR *pfn_vk_get_acceleration_structure_memory_requirements_nv)(vk_device device, const vk_acceleration_structure_memory_requirements_info_nv* p_info, vk_memory_requirements2khr* p_memory_requirements);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_acceleration_structure_memory_khr)(vk_device device, uint32_t bind_info_count, const vk_bind_acceleration_structure_memory_info_khr* p_bind_infos);
typedef vk_result (VKAPI_PTR *pfn_vk_bind_acceleration_structure_memory_nv)(vk_device device, uint32_t bind_info_count, const vk_bind_acceleration_structure_memory_info_khr* p_bind_infos);
typedef void (VKAPI_PTR *pfn_vk_cmd_build_acceleration_structure_nv)(vk_command_buffer command_buffer, const vk_acceleration_structure_info_nv* p_info, vk_buffer instance_data, vk_device_size instance_offset, vk_bool32 update, vk_acceleration_structure_khr dst, vk_acceleration_structure_khr src, vk_buffer scratch, vk_device_size scratch_offset);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_acceleration_structure_nv)(vk_command_buffer command_buffer, vk_acceleration_structure_khr dst, vk_acceleration_structure_khr src, vk_copy_acceleration_structure_mode_khr mode);
typedef void (VKAPI_PTR *pfn_vk_cmd_trace_rays_nv)(vk_command_buffer command_buffer, vk_buffer raygen_shader_binding_table_buffer, vk_device_size raygen_shader_binding_offset, vk_buffer miss_shader_binding_table_buffer, vk_device_size miss_shader_binding_offset, vk_device_size miss_shader_binding_stride, vk_buffer hit_shader_binding_table_buffer, vk_device_size hit_shader_binding_offset, vk_device_size hit_shader_binding_stride, vk_buffer callable_shader_binding_table_buffer, vk_device_size callable_shader_binding_offset, vk_device_size callable_shader_binding_stride, uint32_t width, uint32_t height, uint32_t depth);
typedef vk_result (VKAPI_PTR *pfn_vk_create_ray_tracing_pipelines_nv)(vk_device device, vk_pipeline_cache pipeline_cache, uint32_t create_info_count, const vk_ray_tracing_pipeline_create_info_nv* p_create_infos, const vk_allocation_callbacks* p_allocator, vk_pipeline* p_pipelines);
typedef vk_result (VKAPI_PTR *pfn_vk_get_ray_tracing_shader_group_handles_khr)(vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count, size_t data_size, void* p_data);
typedef vk_result (VKAPI_PTR *pfn_vk_get_ray_tracing_shader_group_handles_nv)(vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count, size_t data_size, void* p_data);
typedef vk_result (VKAPI_PTR *pfn_vk_get_acceleration_structure_handle_nv)(vk_device device, vk_acceleration_structure_khr acceleration_structure, size_t data_size, void* p_data);
typedef void (VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_khr)(vk_command_buffer command_buffer, uint32_t acceleration_structure_count, const vk_acceleration_structure_khr* p_acceleration_structures, vk_query_type query_type, vk_query_pool query_pool, uint32_t first_query);
typedef void (VKAPI_PTR *pfn_vk_cmd_write_acceleration_structures_properties_nv)(vk_command_buffer command_buffer, uint32_t acceleration_structure_count, const vk_acceleration_structure_khr* p_acceleration_structures, vk_query_type query_type, vk_query_pool query_pool, uint32_t first_query);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_acceleration_structure_nv(
    vk_device                                    device,
    const vk_acceleration_structure_create_info_nv*  p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_get_acceleration_structure_memory_requirements_nv(
    vk_device                                    device,
    const vk_acceleration_structure_memory_requirements_info_nv* p_info,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_build_acceleration_structure_nv(
    vk_command_buffer                             command_buffer,
    const vk_acceleration_structure_info_nv*        p_info,
    vk_buffer                                    instance_data,
    vk_device_size                                instance_offset,
    vk_bool32                                    update,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_trace_rays_nv(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    raygen_shader_binding_table_buffer,
    vk_device_size                                raygen_shader_binding_offset,
    vk_buffer                                    miss_shader_binding_table_buffer,
    vk_device_size                                miss_shader_binding_offset,
    vk_device_size                                miss_shader_binding_stride,
    vk_buffer                                    hit_shader_binding_table_buffer,
    vk_device_size                                hit_shader_binding_offset,
    vk_device_size                                hit_shader_binding_stride,
    vk_buffer                                    callable_shader_binding_table_buffer,
    vk_device_size                                callable_shader_binding_offset,
    vk_device_size                                callable_shader_binding_stride,
    uint32_t                                    width,
    uint32_t                                    height,
    uint32_t                                    depth) __asm("vkCmdTraceRaysNV");

VKAPI_ATTR vk_result VKAPI_CALL vk_create_ray_tracing_pipelines_nv(
    vk_device                                    device,
    vk_pipeline_cache                             pipeline_cache,
    uint32_t                                    create_info_count,
    const vk_ray_tracing_pipeline_create_info_nv*     p_create_infos,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_acceleration_structure_handle_nv(
    vk_device                                    device,
    vk_acceleration_structure_khr                  acceleration_structure,
    size_t                                      data_size,
    void*                                       p_data) __asm("vkGetAccelerationStructureHandleNV");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_compile_deferred_nv(
    vk_device                                    device,
    vk_pipeline                                  pipeline,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_memory_host_pointer_properties_ext)(vk_device device, vk_external_memory_handle_type_flag_bits handle_type, const void* p_host_pointer, vk_memory_host_pointer_properties_ext* p_memory_host_pointer_properties);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_memory_host_pointer_properties_ext(
    ...
    vk_memory_host_pointer_properties_ext*           p_memory_host_pointer_properties) __asm("vkGetMemoryHostPointerPropertiesEXT");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_write_buffer_marker_amd)(vk_command_buffer command_buffer, vk_pipeline_stage_flag_bits pipeline_stage, vk_buffer dst_buffer, vk_device_size dst_offset, uint32_t marker);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_write_buffer_marker_amd(
    vk_command_buffer                             command_buffer,
    vk_pipeline_stage_flag_bits                     pipeline_stage,
    vk_buffer                                    dst_buffer,
    vk_device_size                                dst_offset,
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_calibrateable_time_domains_ext)(vk_physical_device physical_device, uint32_t* p_time_domain_count, vk_time_domain_ext* p_time_domains);
typedef vk_result (VKAPI_PTR *pfn_vk_get_calibrated_timestamps_ext)(vk_device device, uint32_t timestamp_count, const vk_calibrated_timestamp_info_ext* p_timestamp_infos, uint64_t* p_timestamps, uint64_t* p_max_deviation);
...
VKAPI_ATTR vk_result VKAPI_CALL vk_get_calibrated_timestamps_ext(
    ...
    const vk_calibrated_timestamp_info_ext*         p_timestamp_infos,
    uint64_t*                                   p_timestamps,
    uint64_t*                                   p_max_deviation) __asm("vkGetCalibratedTimestampsEXT");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_nv)(vk_command_buffer command_buffer, uint32_t task_count, uint32_t first_task);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_indirect_nv)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, uint32_t draw_count, uint32_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_draw_mesh_tasks_indirect_count_nv)(vk_command_buffer command_buffer, vk_buffer buffer, vk_device_size offset, vk_buffer count_buffer, vk_device_size count_buffer_offset, uint32_t max_draw_count, uint32_t stride);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_mesh_tasks_nv(
    vk_command_buffer                             command_buffer,
    uint32_t                                    task_count,
    uint32_t                                    first_task) __asm("vkCmdDrawMeshTasksNV");

VKAPI_ATTR void VKAPI_CALL vk_cmd_draw_mesh_tasks_indirect_nv(
    vk_command_buffer                             command_buffer,
    vk_buffer                                    buffer,
    vk_device_size                                offset,
    uint32_t                                    draw_count,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_exclusive_scissor_nv)(vk_command_buffer command_buffer, uint32_t first_exclusive_scissor, uint32_t exclusive_scissor_count, const vk_rect2d* p_exclusive_scissors);
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_checkpoint_nv)(vk_command_buffer command_buffer, const void* p_checkpoint_marker);
typedef void (VKAPI_PTR *pfn_vk_get_queue_checkpoint_data_nv)(vk_queue queue, uint32_t* p_checkpoint_data_count, vk_checkpoint_data_nv* p_checkpoint_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_checkpoint_nv(
    vk_command_buffer                             command_buffer,
    const void*                                 p_checkpoint_marker) __asm("vkCmdSetCheckpointNV");

VKAPI_ATTR void VKAPI_CALL vk_get_queue_checkpoint_data_nv(
    vk_queue                                     queue,
    uint32_t*                                   p_checkpoint_data_count,
...
typedef vk_result (VKAPI_PTR *pfn_vk_initialize_performance_api_intel)(vk_device device, const vk_initialize_performance_api_info_intel* p_initialize_info);
typedef void (VKAPI_PTR *pfn_vk_uninitialize_performance_api_intel)(vk_device device);
typedef vk_result (VKAPI_PTR *pfn_vk_cmd_set_performance_marker_intel)(vk_command_buffer command_buffer, const vk_performance_marker_info_intel* p_marker_info);
typedef vk_result (VKAPI_PTR *pfn_vk_cmd_set_performance_stream_marker_intel)(vk_command_buffer command_buffer, const vk_performance_stream_marker_info_intel* p_marker_info);
typedef vk_result (VKAPI_PTR *pfn_vk_cmd_set_performance_override_intel)(vk_command_buffer command_buffer, const vk_performance_override_info_intel* p_override_info);
typedef vk_result (VKAPI_PTR *pfn_vk_acquire_performance_configuration_intel)(vk_device device, const vk_performance_configuration_acquire_info_intel* p_acquire_info, vk_performance_configuration_intel* p_configuration);
typedef vk_result (VKAPI_PTR *pfn_vk_release_performance_configuration_intel)(vk_device device, vk_performance_configuration_intel configuration);
typedef vk_result (VKAPI_PTR *pfn_vk_queue_set_performance_configuration_intel)(vk_queue queue, vk_performance_configuration_intel configuration);
typedef vk_result (VKAPI_PTR *pfn_vk_get_performance_parameter_intel)(vk_device device, vk_performance_parameter_type_intel parameter, vk_performance_value_intel* p_value);
...
VKAPI_ATTR void VKAPI_CALL vk_uninitialize_performance_api_intel(
    vk_device                                    device) __asm("vkUninitializePerformanceApiINTEL");
...
VKAPI_ATTR vk_result VKAPI_CALL vk_acquire_performance_configuration_intel(
    vk_device                                    device,
    const vk_performance_configuration_acquire_info_intel* p_acquire_info,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_release_performance_configuration_intel(
    vk_device                                    device,
    vk_performance_configuration_intel             configuration) __asm("vkReleasePerformanceConfigurationINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_queue_set_performance_configuration_intel(
    vk_queue                                     queue,
    vk_performance_configuration_intel             configuration) __asm("vkQueueSetPerformanceConfigurationINTEL");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_performance_parameter_intel(
    vk_device                                    device,
...
typedef void (VKAPI_PTR *pfn_vk_set_local_dimming_amd)(vk_device device, vk_swapchain_khr swap_chain, vk_bool32 local_dimming_enable);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_set_local_dimming_amd(
    vk_device                                    device,
    vk_swapchain_khr                              swap_chain,
...
typedef vk_device_address (VKAPI_PTR *pfn_vk_get_buffer_device_address_ext)(vk_device device, const vk_buffer_device_address_info* p_info);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_buffer_device_address_ext(
    vk_device                                    device,
    const vk_buffer_device_address_info*            p_info) __asm("vkGetBufferDeviceAddressEXT");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_tool_properties_ext)(vk_physical_device physical_device, uint32_t* p_tool_count, vk_physical_device_tool_properties_ext* p_tool_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_cooperative_matrix_properties_nv)(vk_physical_device physical_device, uint32_t* p_property_count, vk_cooperative_matrix_properties_nv* p_properties);
...
typedef vk_result (VKAPI_PTR *pfn_vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv)(vk_physical_device physical_device, uint32_t* p_combination_count, vk_framebuffer_mixed_samples_combination_nv* p_combinations);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv(
    vk_physical_device                            physical_device,
    uint32_t*                                   p_combination_count,
    vk_framebuffer_mixed_samples_combination_nv*     p_combinations) __asm("vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_headless_surface_ext)(vk_instance instance, const vk_headless_surface_create_info_ext* p_create_info, const vk_allocation_callbacks* p_allocator, vk_surface_khr* p_surface);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_headless_surface_ext(
    vk_instance                                  instance,
    const vk_headless_surface_create_info_ext*       p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_surface_khr*                               p_surface) __asm("vkCreateHeadlessSurfaceEXT");
#endif
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_line_stipple_ext)(vk_command_buffer command_buffer, uint32_t line_stipple_factor, uint16_t line_stipple_pattern);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_line_stipple_ext(
    vk_command_buffer                             command_buffer,
    uint32_t                                    line_stipple_factor,
...
typedef void (VKAPI_PTR *pfn_vk_reset_query_pool_ext)(vk_device device, vk_query_pool query_pool, uint32_t first_query, uint32_t query_count);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_reset_query_pool_ext(
    vk_device                                    device,
    vk_query_pool                                 query_pool,
    uint32_t                                    first_query,
...
typedef void (VKAPI_PTR *pfn_vk_cmd_set_primitive_topology_ext)(vk_command_buffer command_buffer, vk_primitive_topology primitive_topology);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_viewport_with_count_ext)(vk_command_buffer command_buffer, uint32_t viewport_count, const vk_viewport* p_viewports);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_scissor_with_count_ext)(vk_command_buffer command_buffer, uint32_t scissor_count, const vk_rect2d* p_scissors);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_vertex_buffers2ext)(vk_command_buffer command_buffer, uint32_t first_binding, uint32_t binding_count, const vk_buffer* p_buffers, const vk_device_size* p_offsets, const vk_device_size* p_sizes, const vk_device_size* p_strides);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_test_enable_ext)(vk_command_buffer command_buffer, vk_bool32 depth_test_enable);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_write_enable_ext)(vk_command_buffer command_buffer, vk_bool32 depth_write_enable);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_compare_op_ext)(vk_command_buffer command_buffer, vk_compare_op depth_compare_op);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_depth_bounds_test_enable_ext)(vk_command_buffer command_buffer, vk_bool32 depth_bounds_test_enable);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_stencil_test_enable_ext)(vk_command_buffer command_buffer, vk_bool32 stencil_test_enable);
typedef void (VKAPI_PTR *pfn_vk_cmd_set_stencil_op_ext)(vk_command_buffer command_buffer, vk_stencil_face_flags face_mask, vk_stencil_op fail_op, vk_stencil_op pass_op, vk_stencil_op depth_fail_op, vk_compare_op compare_op);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_cull_mode_ext(
    vk_command_buffer                             command_buffer,
    vk_cull_mode_flags                             cull_mode) __asm("vkCmdSetCullModeEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_front_face_ext(
    vk_command_buffer                             command_buffer,
    vk_front_face                                 front_face) __asm("vkCmdSetFrontFaceEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_primitive_topology_ext(
    vk_command_buffer                             command_buffer,
    vk_primitive_topology                         primitive_topology) __asm("vkCmdSetPrimitiveTopologyEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_viewport_with_count_ext(
    vk_command_buffer                             command_buffer,
    uint32_t                                    viewport_count,
    const vk_viewport*                           p_viewports) __asm("vkCmdSetViewportWithCountEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_scissor_with_count_ext(
    vk_command_buffer                             command_buffer,
    uint32_t                                    scissor_count,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_test_enable_ext(
    vk_command_buffer                             command_buffer,
    vk_bool32                                    depth_test_enable) __asm("vkCmdSetDepthTestEnableEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_write_enable_ext(
    vk_command_buffer                             command_buffer,
    vk_bool32                                    depth_write_enable) __asm("vkCmdSetDepthWriteEnableEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_compare_op_ext(
    vk_command_buffer                             command_buffer,
    vk_compare_op                                 depth_compare_op) __asm("vkCmdSetDepthCompareOpEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_depth_bounds_test_enable_ext(
    vk_command_buffer                             command_buffer,
    vk_bool32                                    depth_bounds_test_enable) __asm("vkCmdSetDepthBoundsTestEnableEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_stencil_test_enable_ext(
    vk_command_buffer                             command_buffer,
    vk_bool32                                    stencil_test_enable) __asm("vkCmdSetStencilTestEnableEXT");

VKAPI_ATTR void VKAPI_CALL vk_cmd_set_stencil_op_ext(
    vk_command_buffer                             command_buffer,
    vk_stencil_face_flags                          face_mask,
    vk_stencil_op                                 fail_op,
    vk_stencil_op                                 pass_op,
...
typedef void (VKAPI_PTR *pfn_vk_get_generated_commands_memory_requirements_nv)(vk_device device, const vk_generated_commands_memory_requirements_info_nv* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_cmd_preprocess_generated_commands_nv)(vk_command_buffer command_buffer, const vk_generated_commands_info_nv* p_generated_commands_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_execute_generated_commands_nv)(vk_command_buffer command_buffer, vk_bool32 is_preprocessed, const vk_generated_commands_info_nv* p_generated_commands_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_bind_pipeline_shader_group_nv)(vk_command_buffer command_buffer, vk_pipeline_bind_point pipeline_bind_point, vk_pipeline pipeline, uint32_t group_index);
typedef vk_result (VKAPI_PTR *pfn_vk_create_indirect_commands_layout_nv)(vk_device device, const vk_indirect_commands_layout_create_info_nv* p_create_info, const vk_allocation_callbacks* p_allocator, vk_indirect_commands_layout_nv* p_indirect_commands_layout);
typedef void (VKAPI_PTR *pfn_vk_destroy_indirect_commands_layout_nv)(vk_device device, vk_indirect_commands_layout_nv indirect_commands_layout, const vk_allocation_callbacks* p_allocator);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vk_get_generated_commands_memory_requirements_nv(
    vk_device                                    device,
    const vk_generated_commands_memory_requirements_info_nv* p_info,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_indirect_commands_layout_nv(
    vk_device                                    device,
    const vk_indirect_commands_layout_create_info_nv* p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_private_data_slot_ext)(vk_device device, const vk_private_data_slot_create_info_ext* p_create_info, const vk_allocation_callbacks* p_allocator, vk_private_data_slot_ext* p_private_data_slot);
typedef void (VKAPI_PTR *pfn_vk_destroy_private_data_slot_ext)(vk_device device, vk_private_data_slot_ext private_data_slot, const vk_allocation_callbacks* p_allocator);
typedef vk_result (VKAPI_PTR *pfn_vk_set_private_data_ext)(vk_device device, vk_object_type object_type, uint64_t object_handle, vk_private_data_slot_ext private_data_slot, uint64_t data);
typedef void (VKAPI_PTR *pfn_vk_get_private_data_ext)(vk_device device, vk_object_type object_type, uint64_t object_handle, vk_private_data_slot_ext private_data_slot, uint64_t* p_data);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_private_data_slot_ext(
    vk_device                                    device,
    const vk_private_data_slot_create_info_ext*       p_create_info,
    const vk_allocation_callbacks*                p_allocator,
    vk_private_data_slot_ext*                       p_private_data_slot) __asm("vkCreatePrivateDataSlotEXT");

VKAPI_ATTR void VKAPI_CALL vk_destroy_private_data_slot_ext(
    vk_device                                    device,
    vk_private_data_slot_ext                        private_data_slot,
    const vk_allocation_callbacks*                p_allocator) __asm("vkDestroyPrivateDataSlotEXT");

VKAPI_ATTR vk_result VKAPI_CALL vk_set_private_data_ext(
    vk_device                                    device,
    vk_object_type                                object_type,
    uint64_t                                    object_handle,
    vk_private_data_slot_ext                        private_data_slot,
...
VKAPI_ATTR void VKAPI_CALL vk_get_private_data_ext(
    vk_device                                    device,
    vk_object_type                                object_type,
    uint64_t                                    object_handle,
    vk_private_data_slot_ext                        private_data_slot,
