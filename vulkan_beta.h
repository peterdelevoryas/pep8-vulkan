...
typedef vk_result (VKAPI_PTR *pfn_vk_create_deferred_operation_khr)(vk_device device, const vk_allocation_callbacks* p_allocator, vk_deferred_operation_khr* p_deferred_operation);
typedef void (VKAPI_PTR *pfn_vk_destroy_deferred_operation_khr)(vk_device device, vk_deferred_operation_khr operation, const vk_allocation_callbacks* p_allocator);
typedef uint32_t (VKAPI_PTR *pfn_vk_get_deferred_operation_max_concurrency_khr)(vk_device device, vk_deferred_operation_khr operation);
typedef vk_result (VKAPI_PTR *pfn_vk_get_deferred_operation_result_khr)(vk_device device, vk_deferred_operation_khr operation);
typedef vk_result (VKAPI_PTR *pfn_vk_deferred_operation_join_khr)(vk_device device, vk_deferred_operation_khr operation);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_deferred_operation_khr(
    vk_device                                    device,
...
VKAPI_ATTR void VKAPI_CALL vk_destroy_deferred_operation_khr(
    vk_device                                    device,
...
VKAPI_ATTR uint32_t VKAPI_CALL vk_get_deferred_operation_max_concurrency_khr(
    vk_device                                    device,
    vk_deferred_operation_khr                      operation) __asm("vkGetDeferredOperationMaxConcurrencyKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_get_deferred_operation_result_khr(
    vk_device                                    device,
    vk_deferred_operation_khr                      operation) __asm("vkGetDeferredOperationResultKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_deferred_operation_join_khr(
    vk_device                                    device,
    vk_deferred_operation_khr                      operation) __asm("vkDeferredOperationJoinKHR");
#endif
...
typedef vk_result (VKAPI_PTR *pfn_vk_create_acceleration_structure_khr)(vk_device                                           device, const vk_acceleration_structure_create_info_khr*        p_create_info, const vk_allocation_callbacks*       p_allocator, vk_acceleration_structure_khr*                        p_acceleration_structure);
typedef void (VKAPI_PTR *pfn_vk_get_acceleration_structure_memory_requirements_khr)(vk_device device, const vk_acceleration_structure_memory_requirements_info_khr* p_info, vk_memory_requirements2* p_memory_requirements);
typedef void (VKAPI_PTR *pfn_vk_cmd_build_acceleration_structure_khr)(vk_command_buffer                                    command_buffer, uint32_t info_count, const vk_acceleration_structure_build_geometry_info_khr* p_infos, const vk_acceleration_structure_build_offset_info_khr* const* pp_offset_infos);
typedef void (VKAPI_PTR *pfn_vk_cmd_build_acceleration_structure_indirect_khr)(vk_command_buffer                  command_buffer, const vk_acceleration_structure_build_geometry_info_khr* p_info, vk_buffer                                           indirect_buffer, vk_device_size                                       indirect_offset, uint32_t                                           indirect_stride);
typedef vk_result (VKAPI_PTR *pfn_vk_build_acceleration_structure_khr)(vk_device                                           device, uint32_t info_count, const vk_acceleration_structure_build_geometry_info_khr* p_infos, const vk_acceleration_structure_build_offset_info_khr* const* pp_offset_infos);
typedef vk_result (VKAPI_PTR *pfn_vk_copy_acceleration_structure_khr)(vk_device device, const vk_copy_acceleration_structure_info_khr* p_info);
typedef vk_result (VKAPI_PTR *pfn_vk_copy_acceleration_structure_to_memory_khr)(vk_device device, const vk_copy_acceleration_structure_to_memory_info_khr* p_info);
typedef vk_result (VKAPI_PTR *pfn_vk_copy_memory_to_acceleration_structure_khr)(vk_device device, const vk_copy_memory_to_acceleration_structure_info_khr* p_info);
typedef vk_result (VKAPI_PTR *pfn_vk_write_acceleration_structures_properties_khr)(vk_device device, uint32_t acceleration_structure_count, const vk_acceleration_structure_khr* p_acceleration_structures, vk_query_type  query_type, size_t       data_size, void* p_data, size_t stride);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_acceleration_structure_khr)(vk_command_buffer command_buffer, const vk_copy_acceleration_structure_info_khr* p_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_acceleration_structure_to_memory_khr)(vk_command_buffer command_buffer, const vk_copy_acceleration_structure_to_memory_info_khr* p_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_copy_memory_to_acceleration_structure_khr)(vk_command_buffer command_buffer, const vk_copy_memory_to_acceleration_structure_info_khr* p_info);
typedef void (VKAPI_PTR *pfn_vk_cmd_trace_rays_khr)(vk_command_buffer command_buffer, const vk_strided_buffer_region_khr* p_raygen_shader_binding_table, const vk_strided_buffer_region_khr* p_miss_shader_binding_table, const vk_strided_buffer_region_khr* p_hit_shader_binding_table, const vk_strided_buffer_region_khr* p_callable_shader_binding_table, uint32_t width, uint32_t height, uint32_t depth);
typedef vk_result (VKAPI_PTR *pfn_vk_create_ray_tracing_pipelines_khr)(vk_device device, vk_pipeline_cache pipeline_cache, uint32_t create_info_count, const vk_ray_tracing_pipeline_create_info_khr* p_create_infos, const vk_allocation_callbacks* p_allocator, vk_pipeline* p_pipelines);
typedef vk_device_address (VKAPI_PTR *pfn_vk_get_acceleration_structure_device_address_khr)(vk_device device, const vk_acceleration_structure_device_address_info_khr* p_info);
typedef vk_result (VKAPI_PTR *pfn_vk_get_ray_tracing_capture_replay_shader_group_handles_khr)(vk_device device, vk_pipeline pipeline, uint32_t first_group, uint32_t group_count, size_t data_size, void* p_data);
typedef void (VKAPI_PTR *pfn_vk_cmd_trace_rays_indirect_khr)(vk_command_buffer command_buffer, const vk_strided_buffer_region_khr* p_raygen_shader_binding_table, const vk_strided_buffer_region_khr* p_miss_shader_binding_table, const vk_strided_buffer_region_khr* p_hit_shader_binding_table, const vk_strided_buffer_region_khr* p_callable_shader_binding_table, vk_buffer buffer, vk_device_size offset);
typedef vk_result (VKAPI_PTR *pfn_vk_get_device_acceleration_structure_compatibility_khr)(vk_device device, const vk_acceleration_structure_version_khr* version);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_acceleration_structure_khr(
    vk_device                                    device,
    const vk_acceleration_structure_create_info_khr* p_create_info,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR void VKAPI_CALL vk_get_acceleration_structure_memory_requirements_khr(
    vk_device                                    device,
    const vk_acceleration_structure_memory_requirements_info_khr* p_info,
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_build_acceleration_structure_khr(
    ...
    const vk_acceleration_structure_build_offset_info_khr* const* pp_offset_infos) __asm("vkCmdBuildAccelerationStructureKHR");

VKAPI_ATTR void VKAPI_CALL vk_cmd_build_acceleration_structure_indirect_khr(
    vk_command_buffer                             command_buffer,
    const vk_acceleration_structure_build_geometry_info_khr* p_info,
    vk_buffer                                    indirect_buffer,
    vk_device_size                                indirect_offset,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_build_acceleration_structure_khr(
    ...
    uint32_t                                    info_count,
    const vk_acceleration_structure_build_geometry_info_khr* p_infos,
    const vk_acceleration_structure_build_offset_info_khr* const* pp_offset_infos) __asm("vkBuildAccelerationStructureKHR");

VKAPI_ATTR vk_result VKAPI_CALL vk_copy_acceleration_structure_khr(
    vk_device                                    device,
    const vk_copy_acceleration_structure_info_khr*   p_info) __asm("vkCopyAccelerationStructureKHR");
...
VKAPI_ATTR void VKAPI_CALL vk_cmd_trace_rays_khr(
    vk_command_buffer                             command_buffer,
...
VKAPI_ATTR vk_result VKAPI_CALL vk_create_ray_tracing_pipelines_khr(
    ...
    const vk_ray_tracing_pipeline_create_info_khr*    p_create_infos,
    const vk_allocation_callbacks*                p_allocator,
...
VKAPI_ATTR vk_device_address VKAPI_CALL vk_get_acceleration_structure_device_address_khr(
    vk_device                                    device,
    const vk_acceleration_structure_device_address_info_khr* p_info) __asm("vkGetAccelerationStructureDeviceAddressKHR");
