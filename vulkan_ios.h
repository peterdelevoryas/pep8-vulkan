...
typedef vk_result (VKAPI_PTR *pfn_vk_create_iossurface_mvk)(vk_instance instance, const vk_iossurface_create_info_mvk* p_create_info, const vk_allocation_callbacks* p_allocator, vk_surface_khr* p_surface);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR vk_result VKAPI_CALL vk_create_iossurface_mvk(
